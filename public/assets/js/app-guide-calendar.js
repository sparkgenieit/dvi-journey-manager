...
const getGuideId = urlParams.get("id");
const getPaxId = urlParams.get("pax_id");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("engine/json/__JSON_guide_calendar_pricebook_details.php?guide_id=" + getGuideId + '&pax_id=' + getPaxId)
        ...
        .then((data) => {
                ...
                eventClassNames: function ({
                    ...
                    if (e.extendedProps && e.extendedProps.calendar) {
                        const calendarColorMap = {
                            'slot1': 'fc-event-success',
                            'slot2': 'fc-event-warning',
                            'slot3': 'fc-event-danger',
            ...
            function filterEvents() {
                ...
                if (selectedFilters != 'slot1,slot2,slot3') {
