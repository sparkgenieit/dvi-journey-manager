  ...
  const v = new jKanban({
      ...
      click: function (e) {
        var t = e,
          ...
          i = t.getAttribute("data-assigned");
        s.show(),
          ...
          r
            ...
            .insertAdjacentHTML(
              "afterbegin",
              p(i, !1, "xs", "1", e.getAttribute("data-members")) +
      ...
      buttonClick: function (e, a) {
        ...
        n.setAttribute("class", "new-item-form"),
          (n.innerHTML =
            '<div class="mb-3"><textarea class="form-control add-new-item" rows="2" placeholder="Add Content" autofocus required></textarea></div><div class="mb-3"><button type="submit" class="btn btn-primary btn-sm me-2">Add</button><button type="button" class="btn btn-label-secondary btn-sm cancel-add-item">Cancel</button></div>'),
          v.addForm(a, n),
