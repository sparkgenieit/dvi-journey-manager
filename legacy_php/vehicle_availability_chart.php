...
<body>
    ...
    <div class="modal fade" id="assignvehicleFORM" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-simple modal-enable-otp ">
            <div class="modal-content p-3 p-md-5 py-md-4">
                <div class="receiving-vehicle-form-data">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="editDRIVERDATA" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
            <div class="modal-content p-0">
                <div class="modal-body receiving-driver-form-data">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addNEWDRIVER" tabindex="-1" aria-labelledby="adddriverLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-3 p-md-5 receiving-add-driver-form-data">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="addNEWVEHICLE" tabindex="-1" aria-labelledby="addvehicleLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body p-3 p-md-5 receiving-add-vehicle-form-data">
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function show_VEHICLE_LIST() {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_vehicle_availability_list.php',
