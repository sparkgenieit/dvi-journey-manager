...
<body>
                            ...
                            <div class="col-md-12">
                                <div class="card p-0">
                                    <div class="card-header pb-3 d-flex justify-content-between">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-label-primary waves-effect" onclick="showSTAFFMODAL(0);" data-bs-dismiss="modal">+ Add Staff</a>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#staff_LIST').DataTable({
                ...
                buttons: [{
                        ...
                        exportOptions: {
                            columns: [0, 1, 2, 3, 4, 7], // Only name, email and role
                        }
                    },
                    {
                        extend: 'excel',
                ...
                ajax: {
                    "url": "engine/json/__JSONstaff.php",
                    "type": "GET"
                },
                columns: [{
                        data: "count"
        ...
        //ADD & DELETE MODAL
        function showSTAFFMODAL(STAFF_ID) {
            $('.receiving-staff-form-data').load('engine/ajax/__ajax_add_staff.php?type=show_form&STAFF_ID=' + STAFF_ID + '', function() {
                const container = document.getElementById("addSTAFFFORM");
                const modal = new bootstrap.Modal(container);
                modal.show();
                if (STAFF_ID) {
                    $('#STAFFFORMLabel').html('Update Staff');
                } else {
                    $('#STAFFFORMLabel').html('Add Staff');
                }
            });
        }
        //SHOW DELETE POPUP
