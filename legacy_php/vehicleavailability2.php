...
<head>
    ...
    <style>
        ...
        .h6-hover-container:hover .card-hover-itinerary {
            display: block;
        }

        .card-hover-itinerary h6 {
            margin: 0 0 10px 0;
            font-size: 1rem;
        }

        .card-hover-itinerary-text {
                                    ...
                                    <div class="card-body">
                                        <div class="text-nowrap table-responsive table-bordered">
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="sticky-col">Saran Travels</td>
                                                        <td class="sticky-col">
                                                            Sedan</br><span class="text-blue-color">TN 22 SD 0202</span>
                                                        </td>
                                                        <td></td>
                                                        <td class="not-assign-vehicle">
                                                            <div class="h6-hover-container">
                                                                <h6 class="text-blue-color mb-1 cursor-pointer">CQ-DVI202409-002</h6>
                                                                <div class="card-hover-itinerary">
                                                                    <h6 class="card-hover-itinerary-text">View itinerary details and assign a </br> vehicle by clicking here</h6>
                                                                    <button type="button" class="btn btn-sm btn-success waves-effect waves-light ps-2" data-bs-toggle="modal" data-bs-target="#assignvehicleNOTMULTIPL-E">
                                                                        <i class="ti ti-plus fw-bold fs-6 me-1"></i>Assign Vehicle
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            <h6 class="text-blue-color mb-1 cursor-pointer">CQ-DVI202409-003</h6>
                                                            <h6 class="text-blue-color mb-1 cursor-pointer">CQ-DVI202409-011</h6>
                                                            <h6 class="text-blue-color mb-1 cursor-pointer">CQ-DVI202409-023</h6>
                                                            <h6 class="text-blue-color mb-1 cursor-pointer">CQ-DVI202409-007</h6>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="not-assign-vehicle">
                                                            <h6 class="text-blue-color mb-1 cursor-pointer">CQ-DVI202409-002</h6>
                                                            <!-- <button type="button" class="btn btn-sm btn-success waves-effect waves-light ps-2" data-bs-toggle="modal" data-bs-target="#assignvehicleNOTMULTIPL-E"><i class="ti ti-plus fw-bold fs-6 me-1"></i>Assign Vehicle</button> -->
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="sticky-col">Saran Travels</td>
                                                        <td class="sticky-col">
                                                            <a href="javascript:void(0)" class="btn btn-sm btn-label-primary waves-effect" data-bs-toggle="modal" data-bs-target="#addvehicle">+ Add Vehicle</a>
                                                        </td>
                                                        <td></td>
                                                        <td class="not-assign-vehicle">
                                                            <h6 class="text-blue-color mb-1 cursor-pointer">CQ-DVI202409-002</h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="arrival-deparure-vehicle">
                                                            <h6 class="text-blue-color mb-1 d-flex gap-2">CQ-DVI202409-003 <span class="d-flex align-items-center gap-1 mb-1" style="color: #6f6b7d;"><i class="ti ti-calendar-event text-body ti-sm"></i> 06.00 AM</span></h6>

                                                            <h6 class="text-dark mb-2">Chennai => Mahabalipuram</h6>
                                                            <div class="d-flex">
                                                                <div>
                                                                    <h6 class="mb-2"><img src="assets/img/svg/profile.svg" width="26px" height="26px" /> - Saran </h6>
                                                        ...
                                                        <td class="arrival-deparure-vehicle">
                                                            <h6 class="text-blue-color mb-1 d-flex gap-2">CQ-DVI202409-003 <span class="d-flex align-items-center gap-1 mb-1" style="color: #6f6b7d;"><i class="ti ti-calendar-event text-body ti-sm"></i> 09.00 PM</span></h6>
                ...
                <div class="modal-body p-3 p-md-5">
                    ...
                    <form id="addvehicle_details_form" class="row g-3" action="" method="post" data-parsley-validate>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="form-group">
                                <input type="text" name="owner_name" id="owner_name" class="form-control" placeholder="Owner Name" value="" required="">
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
