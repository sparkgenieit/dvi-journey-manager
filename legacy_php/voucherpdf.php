...
foreach ($consecutive_entries as $entry) :
    ...
    if ($logged_user_level != 4) {
        $confirmed_email_ids = explode(',', $hotel_confirmed_email_id);
        $formatted_email_ids = implode('<br/>', array_map('trim', $confirmed_email_ids));
        ...
        <span style="font-weight:semi-bold;font-size:12px;color:#232323;">' . $formatted_email_ids . '<br/>' . $hotel_confirmed_mobile_no . '</span>';
    }

    $table_hotel_details .= '</table> </td> </tr> </table>';


    $table_hotel_details .= '<table cellspacing="0" cellpadding="0" border="0"> <tr> <td style="height:20px;"> </td> </tr> </table>';
