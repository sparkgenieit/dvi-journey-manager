...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) : //CHECK AJAX REQUEST
    ...
    //     echo "SELECT 
    //     h.hotel_name, 
    //     hapb.hotel_amenities_id, 
    //     ha.amenities_title AS amenity_name, 
    //     hapb.pricetype, 
    //     hapb.year, 
    //     hapb.month, 
    //     hapb.day_1, 
    ...
    //     dvi_hotel h
    // LEFT JOIN 
    //     dvi_hotel_amenities_price_book hapb ON h.hotel_id = hapb.hotel_id AND hapb.month = '$month' AND hapb.year = '$year' AND hapb.deleted = '0' AND hapb.status = '1'
    // LEFT JOIN 
    //     dvi_hotel_amenities ha ON ha.hotel_amenities_id = hapb.hotel_amenities_id 
    // WHERE 
    ...
    //     h.hotel_city = '$city' AND
    //     h.deleted = '0' AND
    //     h.status = '1'") or die("#1-UNABLE_TO_COLLECT_HOTEL_LIST:" . sqlERROR_LABEL());
...
LEFT JOIN 
    ...
    AND hapb.month = '$month' 
    AND hapb.year = '$year' 
    AND hapb.deleted = '0' 
    AND hapb.status = '1'
WHERE 
    h.hotel_state = '$state' 
    AND h.hotel_city = '$city' 
    AND h.deleted = '0' 
    AND h.status = '1';") or die("#1-UNABLE_TO_COLLECT_HOTEL_LIST:" . sqlERROR_LABEL());
