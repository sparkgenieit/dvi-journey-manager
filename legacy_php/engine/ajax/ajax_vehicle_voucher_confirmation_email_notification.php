                          ...
                          ">
                                ...
                                " role="presentation">
                                                                    ...
                                                                    <td colspan="2">
                                                                     ...
                                                                     <tr>
                                                                         <th style="text-align: left; border: 1px solid; font-size: 15px; padding: 7px;border-right: 0;border-top: 0;width:160px;color: #001255;">
                                                                             Payment Status</th>
                                                                         <td style="text-align: left; border: 1px solid; font-size: 15px; padding: 7px;border-top: 0;width:400px;">
                                                                            <a href="' . PUBLICPATH . 'vehicleconfirmation.php?id=' . $global_hidden_itinerary_plan_id . '&itinerary_plan_vehicle_details_ID=' . $global_itinerary_plan_vendor_eligible_ID_val . '" target="_blank"> Click here </a> to re confirm the booking and get payment</td>
                                                                     </tr>
                                                                     <tr>
                                                                         <th style="text-align: left; border: 1px solid; font-size: 15px; padding: 7px;border-right: 0;border-top: 0;width:160px;color: #001255;">
                                                                             Special Requests</th>
                                                     ...
                                                     <tr>
                                                         <td align="center">
                                                             <!--[if mso]>
  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="' . PUBLICPATH . 'vehicleconfirmation.php?id=' . $global_hidden_itinerary_plan_id . '&itinerary_plan_vehicle_details_ID=' . $global_itinerary_plan_vendor_eligible_ID_val . '" style="height:36px;v-text-anchor:middle;width:140px;" arcsize="10%" strokecolor="#ed3c0d" fillcolor="#ed3c0d">
    <w:anchorlock/>
    <center style="color:#ffffff;font-family:sans-serif;font-size:13px;font-weight:bold;">Confirm Book</center>
  </v:roundrect>
<![endif]-->
<![if !mso]>
  <a href="' . PUBLICPATH . 'vehicleconfirmation.php?id=' . $global_hidden_itinerary_plan_id . '&itinerary_plan_vehicle_details_ID=' . $global_itinerary_plan_vendor_eligible_ID_val . '" target="_blank" style="
    padding: 8px 16px;
    background: #ed3c0d;
    color: #fff;
...
<![endif]-->
        ...
        $subject = "$site_title - Itinerary Vehicle Confirmation #$global_confirmed_itinerary_quote_ID ($global_primary_customer_name)";
