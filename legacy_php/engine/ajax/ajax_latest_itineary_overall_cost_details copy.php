                            ...
                            <div class="col-md-6">
                                ...
                                <div class="order-calculations">
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-heading">Entry Ticket for Site Seeing (Guest Count: <?= $total_guest_count; ?>)</span>
                                        <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_hotspot_package"><?= number_format((getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_hotspot_amount')), 2); ?></span>
                                        </h6>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-heading">Total for the Activity (Guest Count: <?= $total_guest_count; ?>)</span>
                                        <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_activity_package"><?= number_format((getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_activity_amout')), 2); ?></span>
                                        </h6>
                                    </div>
                                    <?php
                                    ...
                                    ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-heading">Total Guide Charges</span>
                                            <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_vehicle_package"><?= number_format(($TOTAL_ITINEARY_GUIDE_CHARGES), 2); ?></span>
                                            </h6>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (in_array($itinerary_preference, array(1, 3))) : ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_hotel_package"><?= number_format((getITINEARY_COST_DETAILS($itinerary_plan_ID, $_groupTYPE, 'total_hotel_amount')), 2); ?></span>
                                            </h6>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (in_array($itinerary_preference, array(2, 3))) : ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_vehicle_package"><?= number_format((getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_vehicle_amount')), 2); ?></span>
                                            </h6>
                                        </div>
                                    <?php endif; ?>
                                    <hr>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-heading fw-bold">Sub Total</span>
                                        <h6 class="mb-0 fw-bold"><?= general_currency_symbol; ?> <span id="net_total_package"><?= number_format((getITINEARY_COST_DETAILS($itinerary_plan_ID, $_groupTYPE, 'itineary_gross_total_amount')) + ($TOTAL_ITINEARY_GUIDE_CHARGES), 2); ?></span>
                                        </h6>
                                    </div>

                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-heading">Service Charges</span>
                                        <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_vehicle_package"><?= number_format(($total_agent_margin), 2); ?></span>
                                        </h6>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-heading"> GST on Service Charges (<?= $agent_margin_gst_percentage; ?>%) (<?= $agent_margin_gst_label; ?>)</span>
                                        <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_vehicle_package"><?= number_format(($gst_pecentage), 2); ?></span>
                                        </h6>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-heading fw-bold">Total Amount</span>
                                        <h6 class="mb-0 fw-bold"><?= general_currency_symbol; ?> <span id="net_total_package"><?= number_format(($total_net_amount), 2); ?></span>
                                        </h6>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-heading">Coupon Discount</span>
                                        <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="gross_total_vehicle_package"><?= number_format(($total_margin_discount), 2); ?></span>
                                        </h6>
                                    </div>
                                    <?php if ($logged_user_level != 4): ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-heading">Agent Margin</span>
                                            <h6 class="mb-0"><?= general_currency_symbol; ?> <span id="agent_margin"><?= number_format(($agent_margin_value), 2); ?></span>
                                            </h6>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($logged_user_level == 1): ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <h6 class="mb-0 fw-bold"><?= general_currency_symbol; ?> <span id="net_total_package"><?= number_format(round($total_discount_amount + $TOTAL_ITINEARY_GUIDE_CHARGES), 2); ?></span>
                                            </h6>
                                        </div>
                                    <?php else: ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-heading fw-bold">Net Pay</span>
                                            <h6 class="mb-0 fw-bold"><?= general_currency_symbol; ?> <span id="net_total_package_agent"><?= number_format(round($agent_margin_value + $total_discount_amount + $TOTAL_ITINEARY_GUIDE_CHARGES), 2); ?></span>
                                            </h6>
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($logged_user_level == 4): ?>
