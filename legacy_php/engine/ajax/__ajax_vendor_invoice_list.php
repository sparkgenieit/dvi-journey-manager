	  ...
	  <div class="card">
		<div class="card-header pb-3 d-flex justify-content-between">
		  <div class="col-md-auto">
			<h5 class="card-title mb-3 mt-2">List of Vendor Invoice</h5>
		  </div>
		</div>
		<div class="card-body dataTable_select">
		  <div class="table-bordered">
			<table id="vendor_invoice_list" class="table table-hover ">
    ...
    <script>
      $(document).ready(function() {
        $('#vendor_invoice_list').DataTable({
          ...
          ajax: {
            "url": "engine/json/__JSON_vendor_invoice_list.php",
            "type": "GET"
          },
          columns: [{
              data: "counter"
