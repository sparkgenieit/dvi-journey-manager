        ...
        <div class="col-md-12">
            <div class="card p-0">
                <div class="card-header pb-3 d-flex justify-content-between">
                    <h5 class="card-title mb-3">List of Agent</h5>
                    <!-- <a href="javascript:void(0)" class="btn btn-label-primary waves-effect" onclick="showAGENTMODAL(0);" data-bs-dismiss="modal">+ Add Agent</a> -->
                    <a href="agentpdf.php?id=751&confirmid=28" target="_blank" type="button" class="btn btn-label-success"><i class="ti ti-download me-1"></i> Download Voucher</a>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#agent_LIST').DataTable({
                ...
                ajax: {
                    "url": "engine/json/__JSONagent.php",
                    "type": "GET"
                },
                columns: [{
                        data: "count"
                    ...
                    {
                        data: "agent_primary_mobile_number"
                    }, //4
                    {
        ...
        function togglestatusITEM(status, agent_ID) {
            $.ajax({
                type: "POST",
        ...
        // function togglestatusITEM(status, agent_ID) {
        //     var SELECTED_ID = agent_ID;
        //     var SELECTED_STATUS = status;


        //     //alert(SELECTED_ID);
        //     $('.receiving-delete-form-data').load('engine/ajax/__ajax_manage_agent.php?type=updatestatus&AGENT_ID=' +
        //         SELECTED_ID + '&STATUS_ID=' + SELECTED_STATUS + '',
        //         function(response) {
