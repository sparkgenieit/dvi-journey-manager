                                        ...
                                        ?>
                                            ...
                                            <div id="accordionIcon" class="accordion accordion-without-arrow">
                                                ...
                                                $select_itinerary_plan_route_details_query = sqlQUERY_LABEL("
                                                    ...
                                                    INNER JOIN 
                                                        `dvi_confirmed_itinerary_route_guide_details` g
                                                                            ...
                                                                            <div class="tab-pane fade show active">
                                                                                ...
                                                                                ?>
                                                                                    <div class=" d-flex align-items-center justify-content-between gap-2 mb-2 pe-0">
                                                                                        ...
                                                                                        <h5 class="card-header px-0 py-0 mb-2 text-uppercase"></h5>
                                                                                        <!-- <span class="text-heading fw-bold">Defect Type : </span>-->
                                ...
                                <div class="card p-4 px-3">
                                    ...
                                    <div class="mt-4">
                                        <div class="col-12 col-md-12 text-end">
                                            ...
                                            <button id="btn_cancel_guide_<?= $itinerary_route_ID ?>" type="submit" class="btn btn-primary cancel-guide-btn" data-route-id="<?= $itinerary_route_ID ?>">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
