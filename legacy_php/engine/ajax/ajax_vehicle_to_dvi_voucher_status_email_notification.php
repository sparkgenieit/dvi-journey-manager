...
*/
    ...
    if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) :
        ...
        $global_vehicle_type = $_SESSION['global_vehicle_type'];
        $global_g_vehicle_booking_status_label = $_SESSION['global_g_vehicle_booking_status_label'];
        $global_g_vehicle_mobile_no = $_SESSION['global_g_vehicle_mobile_no'];
        $global_g_vehicle_verified_by = $_SESSION['global_g_vehicle_verified_by'];
        $global_g_reservation_no = $_SESSION['global_g_reservation_no'];
        $global_g_vendor_email = $_SESSION['global_g_vendor_email'];
        $global_travel_expert_staff_email = $_SESSION['global_g_travel_expert_staff_email'];

        // Convert the comma-separated email IDs into an array
        $global_vehicle_email_array = explode(',', $global_g_vendor_email);
        ...
        if ($global_travel_expert_staff_email) :
            $email_to = [$global_travel_expert_staff_email, $global_vehicle_email_array, $admin_emailid, $global_default_vehicle_email_array];
        else :
            $email_to = [$global_vehicle_email_array, $admin_emailid, $global_default_vehicle_email_array];
        endif;

        if ($global_g_vehicle_booking_status_label == 'Awaiting'):
            $vehicle_booking_status_color = 'color:#707070;';
        elseif ($global_g_vehicle_booking_status_label == 'Waitinglist'):
            $vehicle_booking_status_color = 'color:#707070;';
        elseif ($global_g_vehicle_booking_status_label == 'Blocked'):
            $vehicle_booking_status_color = 'color:#707070;';
        elseif ($global_g_vehicle_booking_status_label == 'Confirmed'):
            $vehicle_booking_status_color = 'color:#707070;';
        elseif ($global_g_vehicle_booking_status_label == 'Sold Out'):
            $vehicle_booking_status_color = 'color:#707070;';
        endif;

        // $bcc_emailid = $admin_emailid;

        $title = 'Vehicle Voucher - ' . $global_g_vehicle_booking_status_label;
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        ...
                                                        "
                                                        >
                                                        We have updated the status of the booking by <b> Mr/Ms. ' . $global_g_vehicle_verified_by . '</b>. Please review all details carefully to ensure accuracy and completeness before forwarding them to our client.
                                                        </p>
                                                    </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fff" style="
                                                          ...
                                                          <tr>
                                                                ...
                                                                ' . html_entity_decode($global_vehicle_type) . '</td>
                                                            </tr>
                                                              <tr>
                                                                <th
                                                                style="text-align: left;border: 1px solid #000;font-size: 14px;padding: 7px;border-right: 0;width:300px;color: #001255;border-bottom: 0px;">
                                                                ...
                                                                <td
                                                                style="text-align: left; border: 1px solid; font-size: 15px; padding: 7px;width:300px;border-bottom: 0px;">
                                                                ' . html_entity_decode($global_vendor_name) . '</td>
                                                            </tr>
                                                            <tr>
                                                                <th
                                                                style="text-align: left;border: 1px solid #000;font-size: 14px;padding: 7px;border-right: 0;width:300px;color: #001255;border-bottom: 0px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td
                                                                style="text-align: left; border: 1px solid; font-size: 15px; padding: 7px;width:300px;border-bottom: 0px;">
                                                                ' . $global_g_vehicle_verified_by . '</td>
                                                            </tr>
                                                            <tr>
                                                                <th
                                                                style="text-align: left; border: 1px solid; font-size: 14px; padding: 7px;border-right: 0;width:300px;color: #001255;border-bottom: 0px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                ' . $global_g_vehicle_booking_status_label . '</td>
                                                            </tr>
                                                            </thead>
                                                        </table>
                                                        </td>
        ...
        $subject = "$site_title - Itinerary Vehicle Confirmation #" . html_entity_decode($global_vendor_name);
