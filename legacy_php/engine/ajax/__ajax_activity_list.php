...
?>
        ...
        <div class="card">
          <div class="card-header pb-3 d-flex justify-content-between">
            <div class="col-md-auto">
              <h5 class="card-title mb-3 mt-2">List of Activity</h5>
            </div>
            <div class="col-md-auto text-end">
              <a href="activitydetails.php?route=add&formtype=activity_basic_info" id="add_activity" class="btn btn-label-primary waves-effect me-2">+ Add Activity</a>
            </div>
          </div>
          <div class="card-body dataTable_select text-nowrap">
            <div class="text-nowrap table-responsive table-bordered">
              <table id="activity_list" class="table table-hover ">
    ...
    <div class="modal fade" id="showACTIVITYDELETEMODAL" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content receiving-delete-form-activity-data">
        </div>
      </div>
    </div>
    ...
    <script>
      $(document).ready(function() {
        $('#activity_list').DataTable({
          ...
          ajax: {
            "url": "engine/json/__JSONactivity.php",
            "type": "GET"
          },
          columns: [{
              data: "counter"
      ...
      function showACTIVITYDELETEMODAL(ID) {
        $('.receiving-delete-form-activity-data').load('engine/ajax/__ajax_manage_activity.php?type=activity_delete&ID=' + ID, function() {
          const container = document.getElementById("showACTIVITYDELETEMODAL");
      ...
      function confirmACTIVITYDELETE(ID) {
        $.ajax({
          type: "POST",
          url: "engine/ajax/__ajax_manage_activity.php?type=confirm_activity_delete",
          data: {
            _ID: ID
          },
          dataType: 'json',
          success: function(response) {
            if (response.result == true) {
              ...
              $('#showACTIVITYDELETEMODAL').modal('hide');
      ...
      function togglestatusITEM(STATUS_ID, ACTIVITY_ID) {
        if (ACTIVITY_ID) {
          $.ajax({
            type: "POST",
            url: "engine/ajax/__ajax_manage_activity.php?type=update_activity_status",
            data: {
      ...
      function show_ACTIVITY_BASIC_INFO() {
        $.ajax({
          type: 'post',
