...
?>
        ...
        <div class="card p-4 mt-3">
            <div class=" d-flex justify-content-between align-items-center">
                <h5 class="card-header p-0 mb-2 text-uppercase"></h5>
                <!-- <a href="latestconfirmeditinerary_voucherdetails.php?cip_id=<?= $itinerary_plan_ID; ?>" target="_blank" class="btn btn-label-primary waves-effect ps-3"><i class="tf-icons ti ti-notes ti-xs me-1"></i> Voucher Details</a> -->
            </div>
            <?php foreach ($get_unique_vehicle_type as $vehicle_type) :
                $vendor_count++;
                $select_itineary_vehicle_list_query = sqlQUERY_LABEL("SELECT `vehicle_type_id` FROM `dvi_confirmed_itinerary_plan_vehicle_details` WHERE `itinerary_plan_id` = '$itinerary_plan_ID' and `vehicle_type_id` = '$vehicle_type' and `cancellation_status` = '0' AND `deleted` = '0' and `status` = '1' GROUP BY `vehicle_type_id`") or die("#1-UNABLE_TO_COLLECT_VEHICLE_DETAILS_LIST:" . sqlERROR_LABEL());
                        ...
                        <table class="table table-hover border-top-0" width="100%">
                            ...
                            <tbody class="table-borderless" id="itineary_vendor_LIST_<?= $vendor_count; ?>" width="100%">
                                ...
                                while ($fetch_eligible_vendor_data = sqlFETCHARRAY_LABEL($select_itinerary_plan_vendor_data)) :
                                    ...
                                    $vehicle_total_amount = $fetch_eligible_vendor_data['vehicle_total_amount'];
                                ...
                                ?>
                                    <tr class="cursor-pointer" data-vendor-counter="<?= $vendor_counter; ?>">
                                        <td style="max-width: 60px;">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input vehicle-checkbox" <?= $itineary_plan_assigned_status_label; ?> disabled type="radio" id="vehicle_<?= $vehicle_id; ?>" name="selected_vehicles[<?= $vehicle_type; ?>]" value="<?= $vehicle_id; ?>" data-vendor-id="<?= $vendor_id; ?>" data-vehicle-type="<?= $vehicle_type; ?>" data-itinerary_plan_vendor_eligible_ID="<?= $itinerary_plan_vendor_eligible_ID; ?>" data-required-count="<?= $TOTAL_VEHICLE_REQUIRED_COUNT; ?>"><label class="form-check-label" for="choosen_vehicle_<?= $vehicle_id; ?>"></label>
                                            </div>
                                        </td>
                                        <?php if ($logged_user_level != 4) : ?>
                                        ...
                                        <?php if ($logged_vendor_id != '' && $logged_vendor_id != '0'): ?>
                                            ...
                                            <td colspan="2"><?= $total_vehicle_qty; ?> x <?= general_currency_symbol . ' ' . number_format($vehicle_total_amount, 2); ?></td>
                                        <?php else: ?>
                                        ...
                                        <td colspan="2" class="text-end vehicle-price-tooltip-data-section vehicleSection">
                                            <?php if ($vehicle_total_amount > 0) : ?>
                                                <?php if ($logged_user_level != 4 && $logged_user_level != 2) : ?>
                                                ...
                                                <?php elseif ($logged_vendor_id != '' && $logged_vendor_id != '0'): ?>
                                                    <span><b><?= general_currency_symbol . ' ' . number_format(($total_vehicle_qty * $vehicle_total_amount), 2); ?></b></span>
                                                <?php else: ?>
                                    ...
                                    <?php if ($logged_user_level != 4) : ?>
                                        ...
                                        ?>
                                                    ...
                                                    <td>
                                                        <div class="position-relative" style="width: 250px;">
                                                            <div id="carouselExampleDarkTwo" class="carousel carousel-light slide carousel-fade h-100" data-bs-ride="carousel">
                                                                ...
                                                                <div class="carousel-inner">
                                                                    <div class="carousel-item rounded active">
                                                                        <img class="d-block rounded" style="border-radius: 10px; width: 100%; height: 200px" alt="vehicle image" src="assets/img/itinerary/vehicle/thar.jpg">
                                                                    </div>
                                                                    <div class="carousel-item rounded">
                                                                        <img class="d-block rounded" style="border-radius: 10px; width: 100%; height: 200px" alt="vehicle image" src="assets/img/itinerary/vehicle/image_not_available.jpg">
                                                                    </div>
                                                                    <div class="carousel-item rounded">
                                                                        <img class="d-block rounded" style="border-radius: 10px; width: 100%; height: 200px" alt="vehicle image" src="assets/img/itinerary/hotels/parkhotel-4.jpg">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="overlay overlay_vehicle_details_overview_table">
                                                                ...
                                                                <div class="d-flex flex-wrap align-items-center col-12" data-toggle="tooltip" placement="top" title="<?= $itinerary_route_location_from . ' => ' . $itinerary_route_location_to; ?>">
                                                        ...
                                                        <div>
                                                            <?php if ($travel_type == 1) : ?>
                                                                <h6 class="mt-2 mb-0"><?= $travel_type_label; ?> - <?= getTIMELIMIT($vendor_vehicle_type_id, 'get_local_kms_limit', $vendor_id); ?></h6>
                                            ...
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                ...
                                                <td></td>
                                                <td class="text-end"><?= number_format($total_pickup_km, 2); ?></td>
                                            </tr>
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                <td colspan="5" class="text-end">Total Pickup Duration</td>
                                                <td></td>
                                                <td class="text-end"><?= formatTimeDuration($total_pickup_duration); ?></td>
                                            </tr>
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                <td colspan="5" class="text-end">Total Drop KM</td>
                                                <td></td>
                                                <td class="text-end"><?= number_format($total_drop_km, 2); ?></td>
                                            </tr>
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                <td colspan="5" class="text-end">Total Drop Duration</td>
                                                <td></td>
                                                <td class="text-end"><?= formatTimeDuration($total_drop_duration); ?></td>
                                            </tr>
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                            ...
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                <td colspan="5" class="text-end">TOTAL ALLOWED KM (Outstaion KM Only)</td>
                                            ...
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                ...
                                                <td class="text-center"><?= number_format($total_extra_kms, 0, '.', '') . ' * ' . general_currency_symbol . ' ' . number_format($extra_km_rate, 2); ?></td>
                                                <td class="text-end"><?= general_currency_symbol . ' ' . number_format($total_extra_kms_charge, 2); ?></td>
                                            </tr>
                                            <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                            ...
                                            <?php if ($logged_vendor_id != '' && $logged_vendor_id != '0'): ?>
                                                <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                    ...
                                                    <td></td>
                                                    <td class="text-end"><b><?= general_currency_symbol . ' ' . number_format($vehicle_total_amount, 2); ?></b></td>
                                                </tr>
                                            <?php
                                            else: ?>
                                                <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                    <td colspan="5" class="text-end">Vendor Margin (<?= $vendor_margin_percentage . '%'; ?>)</td>
                                                    <td></td>
                                                    <td class="text-end"><?= general_currency_symbol . ' ' . number_format($vendor_margin_amount, 2); ?></td>
                                                </tr>
                                                <tr class="d-none vendor_details_<?= $vendor_counter; ?>">
                                                    <td colspan="5" class="text-end">Vendor Margin Service Tax (<?= $vendor_margin_gst_percentage . '%'; ?>)</td>
                                                    <td></td>
            ...
            $(document).ready(function() {
                ...
                $('.vehicle-checkbox').change(function() {
                    ...
                    if ($(this).prop('checked')) {
                        ...
                        $.ajax({
                            url: 'engine/ajax/ajax_latest_manage_itineary.php?type=confirmed_quotation_itineary_plan_modify_vehicle_vendor',
                            method: 'POST',
                            data: {
                                itinerary_plan_id: '<?= $itinerary_plan_ID; ?>',
                                itinerary_plan_vendor: itinerary_plan_vendor,
                                vendor_ID: vendor_ID,
