                ...
                <div class="col-md-6 my-auto text-end">
                    <?php if ($logged_user_level == 1): ?>
                        <div class="media-body switch-sm">
                            <label class="switch mt-0 mb-0 me-5">
                                <input type="checkbox" <?php if ($hotel_rates_visibility == 1): echo 'checked';
                                                        endif; ?> name="check_show_hotel_rates" id="check_show_hotel_rates" class="switch-input" onchange="showHOTELRATES('<?= $itinerary_plan_ID; ?>')">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                </span>
                            </label>
                            <span class="fw-bold">Display Rates</span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                            ...
                            <tbody class="border-top-0" id="itineary_hotel_LIST">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($itinerary_no_of_days <= $itinerary_additional_margin_day_limit && $logged_agent_id) {
                                            // Calculate additional margin
                                            $additional_margin = ($itinerary_additional_margin_percentage * $grand_total_hotel_charges) / 100;
                                        } else {
                                            $additional_margin = 0;
                                        }

                                        // Format the number
                                        $formatted_grand_total = number_format(($grand_total_hotel_charges + $additional_margin), 2);
                                        ?>
