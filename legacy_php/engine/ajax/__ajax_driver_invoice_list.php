	  ...
	  <div class="card">
		<div class="card-header pb-3 d-flex justify-content-between">
		  <div class="col-md-auto">
			<h5 class="card-title mb-3 mt-2">List of Driver Invoice</h5>
		  </div>
		</div>
		<div class="card-body dataTable_select">
		  <div class="table-bordered">
			<table id="driver_invoice_list" class="table table-hover ">
    ...
    <script>
      $(document).ready(function() {
        $('#driver_invoice_list').DataTable({
          ...
          ajax: {
            "url": "engine/json/__JSON_driver_invoice_list.php",
            "type": "GET"
          },
          columns: [{
              data: "counter"
          ...
          columnDefs: [{
              ...
              "render": function(data, type, row, full) {
                switch (data) {
                  case '1':
                    return '<span class="badge bg-label-success me-1 cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Active">Active</span>';
                    break;
                  case '0':
                    return '<span class="badge bg-label-danger me-1 cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="In-Active">In-Active</span>';
                    break;
                }
              }
            },
