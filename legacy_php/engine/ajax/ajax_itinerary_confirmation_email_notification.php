...
*/
    ...
    if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) :
        ...
        $confirmed_itinerary_quote_ID = $_SESSION['global_confirmed_itinerary_quote_ID'];
        $itinerary_quote_ID = get_ITINERARY_PLAN_DETAILS($itinerary_plan_ID, 'itinerary_quote_ID');
        $arrival_location = $_SESSION['global_arrival_location'];
        $departure_location = $_SESSION['global_departure_location'];
        $no_of_days = $_SESSION['global_no_of_days'];
        $no_of_nights = $_SESSION['global_no_of_nights'];
        ...
        if ($travel_expert_id) :
            ...
            $email_to = [$travel_expert_staff_email, $admin_emailid, $global_default_vehicle_email_array, $global_default_hotel_email_array, $global_default_accounts_email_array];
        else :
            $email_to = [$admin_emailid, $global_default_vehicle_email_array, $global_default_hotel_email_array, $global_default_accounts_email_array];
        endif;
...
<tr>
  ...
  ">
    ...
    <thead>
        ...
        <tr>
            ...
            <td align="left" align="top" style="border:1px solid #000000; font-size:15px; padding:0; width:300px; border-bottom:0;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                    <tr>
                        <td style="padding:7px; font-size:15px; text-align:left;">
                           <a href="' . BASEPATH . 'latestconfirmeditinerary.php?route=add&formtype=generate_itinerary&id=' . $itinerary_plan_ID . '">' . $confirmed_itinerary_quote_ID . '</a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td align="left" align="top" style="border:1px solid #000000; font-size:15px; padding:0; width:300px; border-bottom:0;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                    <tr>
                        <td style="padding:7px; font-size:15px; text-align:left;">
                           <a href="' . BASEPATH . 'latestitinerary.php?route=add&formtype=generate_itinerary&id=' . $itinerary_plan_ID . '">' . $itinerary_quote_ID . '</a>
                        </td>
                    </tr>
                </table>
            </td>
         ...
         <tr>
            ...
            <td align="left" align="top" style="border:1px solid #000000; font-size:15px; padding:0; width:300px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                    <tr>
                        <td style="padding:7px; font-size:15px; text-align:left;">
                          ' . date('M d, Y', strtotime($trip_start_date_and_time)) . ' to ' . date('M d, Y', strtotime($trip_end_date_and_time)) . '
                        </td>
                    </tr>
                </table>
            </td>
        ...
        $subject = "$site_title - Itinerary Confirmation #$confirmed_itinerary_quote_ID";
