...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="input-group">
            <input name="activity_year" id="activity_year" autocomplete="off" required class="form-control"
                placeholder="Month" />
        </div>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="card-body dataTable_select text-nowrap">
            <div class="text-nowrap table-responsive table-bordered">
                <table class="table table-hover" id="activity_LIST">
                    <thead>
                        <tr>
...
<script>
var dataTable = $('#activity_LIST').DataTable({
    dom: 'Blfrtip',
    "bFilter": true,
    buttons: [{
            extend: 'copy',
    ...
    ajax: {
        "url": "engine/json/__JSON_activity_pricebook_latest.php",
        "type": "GET"
    },
    columns: [{
            data: "count"
