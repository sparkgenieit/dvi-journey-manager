        ...
        <div class="row">
            <div class="card p-0">
                <div class="card-header p-3 d-flex justify-content-between">
                    <div class="col-md-8">
                        <h5 class="card-title mb-3 mt-2">List of Drivers</h5>
                    </div>
                    <div class="col-md-4 text-end">

                        <a href="driver.php?route=add&formtype=driver_basic_info" id="add_driver" class="btn btn-label-primary waves-effect me-2" onclick=show_DRIVER_FORM_STEP1(0);>+ Add Driver</a>
                    </div>
                </div>
                <div class="card-body dataTable_select text-nowrap">
                    <div class="text-nowrap table-responsive table-bordered">
                        <table id="driver_LIST" class="table table-hover">
        ...
        <script>
            $(document).ready(function() {
                $('#driver_LIST').DataTable({
                    ...
                    ajax: {
                        "url": "engine/json/__JSONdriver.php",
                        "type": "GET"
                    },
                    columns: [{
                            data: "counter"
                        ...
                        {
                            data: "driver_primary_mobile_number"
                        }, //3
                        {
                            data: "driver_license_number"
                        }, //4
                        {
                            data: "driver_licence_status"
                        }, //5
                        {
                            data: "status"
                        } //6
                    ...
                    columnDefs: [{
                            ...
                            "render": function(data, type, row, full) {
                                switch (data) {
                                    case '1':
                                        return '<div class="media-body text-start switch-sm"><label class="switch mt-0"><input type="checkbox" id="switch_status_' + row.modify + '" class="switch-input" checked onChange="togglestatusITEM(' + data + ',' + row.modify + ');"><span class="switch-toggle-slider"><span class="switch-on"></span></span></label></div>';
                                        break;
                                    case '0':
                                        return '<div class="media-body text-start switch-sm"><label class="switch mt-0"><input type="checkbox" id="switch_status_' + row.modify + '" class="switch-input"  onChange="togglestatusITEM(' + data + ',' + row.modify + ');"><span class="switch-toggle-slider"><span class="switch-on"></span></span></label></div>';
                                        break;
                                }
                            }
                        },
            ...
            function showDELETEDRIVERMODAL(ID) {
                $('.receiving-confirm-delete-form-data').load('engine/ajax/__ajax_manage_driver.php?type=delete&ID=' + ID, function() {
