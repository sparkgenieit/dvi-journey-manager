...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) : //CHECK AJAX REQUEST
    ...
    if ($_GET['type'] == 'show_form') :
        ...
        $total_net_charge = round((getITINEARY_COST_DETAILS($itinerary_plan_ID, $_groupTYPE, 'itineary_gross_total_amount')) + ($TOTAL_ITINEARY_GUIDE_CHARGES));
...
?>
        ...
        <div id="contentToCopy">
            <div class="row mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="order-calculations">
                                    <?php if (in_array($itinerary_preference, array(1, 3))) : ?>
                                        <?php
                                        $total_room_cost = round(getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $_groupTYPE, 'TOTAL_HOTEL_ROOM_COST') + getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $_groupTYPE, 'TOTAL_HOTEL_MARGIN_RATE'));
                                        if ($total_room_cost > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-heading">Total Room Cost <b>(<?= get_ITINERARY_PLAN_DETAILS($itinerary_plan_ID, 'preferred_room_count'); ?>)</b></span>
                                                <h6 class="mb-0"><?= general_currency_symbol; ?> <span><?= number_format($total_room_cost, 2); ?></span></h6>
                                            </div>
                                        <?php endif; ?>

                                        <?php
                                        $amenities_cost = round(getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $_groupTYPE, 'TOTAL_HOTEL_AMENITIES_COST'));
                                        if ($amenities_cost > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <?php
                                        $meal_cost = round(getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $_groupTYPE, 'TOTAL_FOOD_COST'));
                                        if ($meal_cost > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-heading">Meal Plan Cost</span>
                                                <h6 class="mb-0"><?= general_currency_symbol; ?> <span><?= number_format($meal_cost, 2); ?></span></h6>
                                            </div>
                                        <?php endif; ?>

                                        <?php
                                        $extra_bed_cost = round(getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $_groupTYPE, 'TOTAL_EXTRABED_COST'));
                                        if ($extra_bed_cost > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-heading">Extra Bed Cost <b>(<?= get_ITINERARY_PLAN_DETAILS($itinerary_plan_ID, 'total_extra_bed'); ?>)</b></span>
                                                <h6 class="mb-0"><?= general_currency_symbol; ?> <span><?= number_format($extra_bed_cost, 2); ?></span></h6>
                                            </div>
                                        <?php endif; ?>

                                        <?php
                                        $cwb_cost = round(getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $_groupTYPE, 'TOTAL_CWB_COST'));
                                        if ($cwb_cost > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-heading">Child With Bed Cost <b>(<?= get_ITINERARY_PLAN_DETAILS($itinerary_plan_ID, 'total_child_with_bed'); ?>)</b></span>
                                                <h6 class="mb-0"><?= general_currency_symbol; ?> <span><?= number_format($cwb_cost, 2); ?></span></h6>
                                            </div>
                                        <?php endif; ?>

                                        <?php
                                        $cnb_cost = round(getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $_groupTYPE, 'TOTAL_CNB_COST'));
                                        if ($cnb_cost > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <h6 class="mb-0"><?= general_currency_symbol; ?> <span><?= number_format($cnb_cost, 2); ?></span></h6>
                                            </div>
                                        <?php endif; ?>

                                        <?php
                                        $hotel_tax = round(getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, $_groupTYPE, 'total_margingst_cost_hotel') + getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, $_groupTYPE, 'total_gst_cost_hotel'));
                                        if ($hotel_tax > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                                <span class="text-heading">Total Hotel Tax</span>
                                                <h6 class="mb-0"><?= general_currency_symbol; ?> <span><?= number_format($hotel_tax, 2); ?></span></h6>
                                            </div>
                                        <?php endif; ?>

                                        <?php
                                        $hotel_total = round(getITINEARY_COST_DETAILS($itinerary_plan_ID, $_groupTYPE, 'total_hotel_amount', ""));
                                        if ($hotel_total > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <?php if (in_array($itinerary_preference, array(2, 3))) : ?>
                                        <?php
                                        $vehicle_cost = round(getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, '', 'total_confirmed_vendor_vehicle_amount', '') + getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, '', 'total_vendor_margin_amount', ''));
                                        if ($vehicle_cost > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <?php
                                        $vehicle_tax = round(getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, '', 'total_vendor_tax_amount'));
                                        if ($vehicle_tax > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <?php
                                        $vehicle_total = $vehicle_cost + $vehicle_tax;
                                        if ($vehicle_total > 0):
                                        ?>
                                            <div class="d-flex justify-content-between mb-2">
                                    ...
                                    ?>
                                        <div class="row mb-2">
                                            <div class="col-8"><span class="text-heading">Total Guide Cost (Including Service Charge)</span></div>
                                    ...
                                    ?>
                                        <div class="row mb-2">
                                            <div class="col-8"><span class="text-heading">Total Hotspot Cost (Including Service Charge)</span></div>
                                            <div class="col-4 text-end">
                                    ...
                                    ?>
                                        <div class="row mb-2">
                                            <div class="col-8"><span class="text-heading">Total Activity Cost (Including Service Charge)</span></div>
                                            <div class="col-4 text-end">
                                    ...
                                    <?php if ($logged_user_level == 1): ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <h6 class="mb-0 fw-bold"><?= general_currency_symbol; ?> <span><?= number_format(round($total_discount_amount + $TOTAL_ITINEARY_GUIDE_CHARGES), 2); ?></span></h6>
                                        </div>
                                    <?php else: ?>
                                        <div class="d-flex justify-content-between mb-2">
                                            <span class="text-heading fw-bold">Net Pay</span>
                                            <h6 class="mb-0 fw-bold"><?= general_currency_symbol; ?> <span><?= number_format(round($agent_margin_value + $total_discount_amount + $TOTAL_ITINEARY_GUIDE_CHARGES), 2); ?></span></h6>
                                        </div>
                                    <?php endif; ?>
                ...
                <div class=" d-flex justify-content-center" id="remove-this">
                    ...
                    <!-- <div class="demo-inline-spacing">
                        <?php if (in_array($itinerary_preference, array(1, 3))) : ?>
                            <button type="button" class="btn btn-success waves-effect waves-light ps-3" data-bs-toggle="modal" data-bs-target="#pdfrecommended"><i class="tf-icons ti ti-download ti-xs me-1"></i> Download PDF</button>
                            <?php else: ?>
                                <a target="_blank" href="new_itinerary_recommend_pdf.php?id=<?= $itinerary_plan_ID ?>" class="btn btn-success waves-effect waves-light"><i class="tf-icons ti ti-download ti-xs me-1"></i> Download PDF</a>
                            <?php endif; ?>
                            
                        </div> -->
                    <div class="demo-inline-spacing">

                        <!--                         <button type="button" class="btn btn-success waves-effect waves-light ps-3" id="download-pdf-btn"><i class="tf-icons ti ti-download ti-xs me-1"></i> Download PDF</button>
 -->
                    </div>
                    <div class="demo-inline-spacing">
                        <div class="btn-group" id="hover-dropdown-demo">
 ...
 -->
        ...
        <script>
            function pdfRecommended(itineraryPlanID) {
                // Collect individual recommended checkbox values
                const recommended1 = $('#pdfrecommended1').is(':checked') ? 1 : 0;
                const recommended2 = $('#pdfrecommended2').is(':checked') ? 2 : 0;
                const recommended3 = $('#pdfrecommended3').is(':checked') ? 3 : 0;
                const recommended4 = $('#pdfrecommended4').is(':checked') ? 4 : 0;

                // Encode itineraryPlanID for URL
                const ID = encodeURIComponent(itineraryPlanID);

                // Construct the URL with each recommended value as a separate parameter
                const url = `new_itinerary_recommend_pdf.php?id=${ID}&recommended1=${recommended1}&recommended2=${recommended2}&recommended3=${recommended3}&recommended4=${recommended4}`;
