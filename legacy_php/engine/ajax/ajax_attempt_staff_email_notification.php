...
*/
    ...
    if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) :
        ...
        $subscription_plan_id = $_SESSION['global_sid'];
        $total_staff_count = $_SESSION['global_staff_count'];
        $agent_id = $_SESSION['global_agent_id'];
        $total_staff_charges = $_SESSION['global_total_charges'];

        $subscription_plan_title = get_AGENT_SUBSCRIBED_PLAN_DETAILS($subscription_plan_id, $agent_id, 'subscription_plan_title');
        ...
        if ($travel_expert_id) :
            ...
            $email_to = [$travel_expert_staff_email, $admin_emailid];
        else :
            $email_to = [$admin_emailid];
        endif;

        $title = 'Attempt to Add New Staff';
        $site_title = getGLOBALSETTING('site_title');
        $description = "Agent <b>$agent_name</b>, <br/> <br/> who is currently subscribed to the <b>$subscription_plan_title</b> plan, is attempting to add a new staff member. However, the agent has already reached the maximum staff limit allowed under this plan.";
 ...
 <body style="
  ...
  >
    <!--[if !mso]><!-- -->
    <img
      src="' . BASEPATH . '/assets/img/staff_add.png"
      alt="Logo"
      style="
        display: block;
        border: 0;
    ...
    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:300px;">
      <v:fill type="frame" src="' . BASEPATH . '/assets/img/staff_add.png" color="#ffffff" />
...
<tr>
  ...
  ">
    ...
    <thead>
        ...
        <tr>
            ...
            <td align="left" align="top" style="border:1px solid #000000; font-size:15px; padding:0; width:300px; border-bottom:0;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                    <tr>
                        <td style="padding:7px; font-size:15px; text-align:left;">
                            ' . general_currency_symbol . ' ' . number_format($total_staff_charges, 2) . '
                        </td>
                    </tr>
                </table>
            </td>
        ...
        $subject = "$site_title - Attempt to Add New Staff Member";
