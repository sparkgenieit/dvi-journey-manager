...
?>
                ...
                <div class="card p-0">
                    <div class="card-header pb-3 d-flex justify-content-between">
                        <div class="col-md-auto">
                            <h5 class="card-title mb-3 mt-2">List of Itineray</h5>
                        </div>
                    </div>
                    <div class="card-body dataTable_select text-nowrap">
                        <div class="text-nowrap overflow-hidden table-bordered">
                            <table id="guide_LIST" class="table table-hover table-responsive">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Quote ID</th>
        ...
        <script>
            $(document).ready(function() {
                ...
                var dataTable = $('#guide_LIST').DataTable({
                    dom: 'Blfrtip',
                    "bFilter": true,
                    buttons: [{
                            extend: 'copy',
                    ...
                    ajax: {
                        "url": "engine/json/__JSONguideitinerary.php?hotel_state=<?= $hotel_state; ?>&hotel_city=<?= $hotel_city; ?>",
                        "type": "GET"
                    },
                    columns: [{
                            data: "count"
                    ...
                    columnDefs: [{
                        ...
                        "render": function(data, type, row, full) {
                            return '<a class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" href="latestconfirmeditinerary.php?route=add&formtype=generate_itinerary&id=' +
                                data + '"  style="margin-right: 10px;">' + row.itinerary_quote_ID +
                                '</a>';
