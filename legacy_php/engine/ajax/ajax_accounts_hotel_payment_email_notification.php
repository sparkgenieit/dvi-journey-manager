...
*/
    ...
    $global_hotel_ID = $_SESSION['global_hotel_ID'];
    ...
    $global_accounts_itinerary_hotel_details_ID = $_SESSION['global_accounts_itinerary_hotel_details_ID'];
    $global_payment_amount = $_SESSION['global_payment_amount'];

        $admin_emailid = getGLOBALSETTING('cc_email_id');

        $email_to = [$global_travel_expert_staff_email, $global_hotel_email, $admin_emailid];
        ...
        $total_paid = getACCOUNTS_MANAGER_DETAILS($global_hidden_itinerary_plan_id, $global_hotel_ID,'total_paid_hotel_amount');
        $total_balance = getACCOUNTS_MANAGER_DETAILS($global_hidden_itinerary_plan_id, $global_hotel_ID, 'total_balance');
        ...
        $getstatus_query_hotel = sqlQUERY_LABEL("SELECT `accounts_itinerary_hotel_transaction_history_ID`,`transaction_amount`,`transaction_date`,`transaction_done_by`,`mode_of_pay`,`transaction_utr_no` FROM `dvi_accounts_itinerary_hotel_transaction_history` WHERE `deleted` = '0' AND `accounts_itinerary_hotel_details_ID` =  $global_accounts_itinerary_hotel_details_ID") or die("#getROOMTYPE_DETAILS: JOIN_QUERY_ERROR: " . sqlERROR_LABEL());
                ...
                <tr>
                    <td align="center" valign="top" style="padding: 0; margin: 0; width: 520px">
                        <table cellpadding="0" cellspacing="0" width="90%" bgcolor="#fff" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: separate; border-spacing: 0px;" role="presentation">
                            <tbody>
                                <tr>
                                    <th style="text-align: left; border: 1px solid #000; font-size: 15px; padding: 7px; border-right: 0; width: 160px; background-color: #00bb1f; color: #FFF;">Payment #' . $hotelcount . '</th>
                                ...
                                <tr>
                                  ...
                                  >
                                    <h3
                                      ...
                                      "
                                    >
                                    Payment of <b>'. $global_payment_amount .'</b> to Hotel <b>('. $global_hotel_name .')</b> was successful!
                                      Your Hotel 
                                      Payment is Success !!!
                                    </h3>
                                    <div
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td
                                            ...
                                            "
                                          >
                                            ' . html_entity_decode($global_hotel_name) . '
                                          </td>
                                        </tr>
                                        <tr>
                                          <th
                                        ...
                                        <tr>
                                          ...
                                          <td
                                            ...
                                            "
                                          >
                                            ' . $global_preferred_room_count . ' Rooms | ' . $global_formattedoccupancyDetails . '
                                          </td>
                                        </tr>
                                        <tr>
                                          <th
...
';
        $subject = "$site_title - Itinerary Hotel Payment #$global_confirmed_itinerary_quote_ID";
