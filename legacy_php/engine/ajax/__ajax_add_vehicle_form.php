                ...
                <div class="card p-4">
                    <form id="form_vendor_branch_form" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label" for="modalAddCard">Vehicle Name<span class=" text-danger"> *</span></label>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" name="registration_number" id="registration_number" class="form-control" placeholder="Enter the Registration Number" value="<?= $registration_number; ?>" />
                                </div>
                            </div>
                            <div class="col-md-4 position-relative">
                                <label class="form-label" for="registration-date">Registration Date<span class="text-danger"> *</span></label>
                                <div class="form-group">
                                    <input type="text" name="registration_date" id="registration_date" class="form-control" placeholder="Enter Registration Date" value="<?= $registration_date; ?>" />
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" name="engine_number" id="engine_number" class="form-control" placeholder="Enter the Engine Number" value="<?= $engine_number; ?>" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="owner_Name">Owner Name<span class=" text-danger"> *</span></label>
                                <div class="form-group">
                                    <input type="text" name="owner_Name" id="owner_Name" class="form-control" placeholder="Enter the Owner Name" value="<?= $owner_name; ?>" />
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" name="chassis_number" id="chassis_number" class="form-control" placeholder="Enter the Chassis Number" value="<?= $chassis_number; ?>" />
                                </div>
                            </div>
                            <div class="col-md-4 position-relative">
                                <label class="form-label" for="chassis_number">vehicle Expiry Date <span class=" text-danger"> *</span></label>
                                <div class="form-group">
                                    <input type="text" name="fc_expiry_date" id="fc_expiry_date" class="form-control" placeholder="Enter Registration Date" value="<?= $vehicle_fc_expiry_date; ?>" />
                                    <span class="calender-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="20px" height="20px" x="0" y="0" viewBox="0 0 682.667 682.667" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                            <g>
                                                <defs>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" name="insurance_policy_number" id="insurance_policy_number" class="form-control" placeholder="Enter the Insurance Policy Number" value="<?= $insurance_policy_number; ?>" />
                                </div>
                            </div>
                            <div class="col-md-4 position-relative">
                                <label class="form-label" for="insurance_start_date">Insurance Start Date<span class=" text-danger"> *</span></label>
                                <div class="form-group">
                                    <input type="text" name="insurance_start_date" id="insurance_start_date" class="form-control" placeholder="Enter Insurance Start Date" value="<?= $insurance_start_date; ?>" />
                                    <span class="calender-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="20px" height="20px" x="0" y="0" viewBox="0 0 682.667 682.667" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                            <g>
                                                <defs>
                            ...
                            <div class="col-md-4 position-relative">
                                <label class="form-label" for="insurance_expiry_date">Insurance Expiry Date<span class=" text-danger"> *</span></label>
                                <div class="form-group">
                                    <input type="text" name="insurance_expiry_date" id="insurance_expiry_date" class="form-control" placeholder="Enter Insurance Expiry Date" value="<?= $insurance_expiry_date; ?>" />
                                    <span class="calender-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="20px" height="20px" x="0" y="0" viewBox="0 0 682.667 682.667" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                            <g>
                                                <defs>
                            ...
                            <div class="col-md-4">
                                <label class="form-label" for="insurance_company_number">Insurance Company Number<span class=" text-danger"> *</span></label>
                                <div class="form-group">
                                    <input type="text" name="insurance_company_number" id="insurance_company_number" class="form-control" placeholder="Enter the Insurance Company Number" value="<?= $insurance_company_name; ?>" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="rto_code">RTO Code<span class=" text-danger"> *</span></label>
                                <div class="form-group">
                                    <input type="text" name="rto_code" id="rto_code" class="form-control" placeholder="Enter the RTO Code" value="<?= $RTO_code; ?>" />
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn btn-label-github waves-effect ps-3"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-narrow-left me-1" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            ?>
                            <button type="submit" id="submit_vendor_vehicle" class="btn btn-primary waves-effect waves-light pe-3"><?= $value; ?><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-narrow-right ms-1" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path d="M5 12l14 0"></path>
