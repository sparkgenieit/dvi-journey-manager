            ...
            <div class="col-md-12">
                <div id="wizard-validation" class="bs-stepper box-shadow-none">
                    <div class="bs-stepper-header border-0 justify-content-start py-2">
                        ...
                        <div class="step">
                            <a href="<?= $hotel_feedback_url; ?>" class="step-trigger">
                                <span class="bs-stepper-circle disble-stepper-num">5</span>
                                <span class="bs-stepper-label mt-3">
                                    <h5 class="bs-stepper-title  disble-stepper-title">Review & Feedback </h5>
                                </span>
                            </a>
                        </div>
                        <div class="line">
                    ...
                    <form id="form_hotel_basic_info" action="" method="POST" data-parsley-validate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="hotel_country" id="hotel_country" onchange="CHOOSEN_COUNTRY()" data-parsley-trigger="keyup">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="hotel_state" id="hotel_state" onchange="CHOOSEN_STATE()" data-parsley-trigger="keyup">
                                    <option value="">Please Choose State</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="hotel_city">City <span class="text-danger">*</span></label>
                                <select class="form-select" name="hotel_city" id="hotel_city" onchange="CHOOSEN_CITY()" data-parsley-trigger="keyup">
                        ...
                        ?>
                                <div class="row g-3" id="room_<?= $room_ID; ?>">
                                    ...
                                    <div class="col-md-4"><label class="form-label" for="gst_status">GST Type<span class="text-danger">*</span></label>
                                        <select id="gst_status" name="gst_status[]" class="form-control form-select" required><?= getGESTTYPE($gst_status, 'select') ?></select>
                                    </div>
        ...
        <div class="row sticky-element">
                    ...
                    <div class="card mb-4 p-4">
                        ...
                        <form id="form_guide_review" class="row g-2" action="" method="post" data-parsley-validate>
                            <div class="col-12 row g-2" id="ajax_form_review">
                                <div class="col-12">
                                    <label class="form-label text-primary fs-5" for="guide_rating">Rating</label>
                                    <div class="form-group">
                                        <div id="edited_star_ratings" data-rateyo-full-star="true"></div>
                                        <input type="hidden" name="guide_rating" id="guide_rating" value="1" />
                                    </div>
                ...
                <div class="col-8">
                    <div class="card mb-4 p-4">
                        <div class="card-datatable dataTable_select text-nowrap">
                            ...
                            <table id="hotel_review_LIST" class="dt-select-table table-bordered table">
                                <thead>
                                    <tr>
                                        <th>S.no</th>
                                        <th>Rating</th>
            ...
            <script>
                        ...
                        $.ajax({
                            ...
                            if (!response.success) {
                                ...
                                if (response.i_result == true) {
                                    ...
                                    //RESULT FAILED
                                    TOAST_NOTIFICATION('success', 'Unable to Add Guide Review', 'Success !!!', '', '', '', '', '', '', '', '', '');
                                } else if (response.u_result == false) {
                                    //RESULT FAILED
                                    TOAST_NOTIFICATION('success', 'Unable to Update Guide Review', 'Success !!!', '', '', '', '', '', '', '', '', '');
                                }
                            }
                            if (response == "OK") {
                                return true;
                ...
                function show_RATING_FORM(id, review_id) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#submit_hotel_basic_info_btn').text('Update');
                            $("#edited_star_ratings").rateYo({
                ...
                function showHOTELREVIEWDELETEMODAL(ID) {
                    ...
                    $('.receiving-delete-form-data').load('engine/ajax/__ajax_manage_hotel.php?type=hotel_review_delete&ID=' + ID, function() {
                        const container = document.getElementById("showDELETEMODAL");
                        const modal = new bootstrap.Modal(container);
                        modal.show();
                    });
                        ...
                        <div class="row">
                            ...
                            if ($total_rooms_num_rows_count > 0) :
                                while ($fetch_room_data = sqlFETCHARRAY_LABEL($select_room_details)) :
                                    ...
                                    $check_out_time = $fetch_room_data['check_out_time'];
                                    $gst_status = $fetch_room_data['gst_type'];
                                    $gst_status_type = getGESTTYPE($gst_status, 'label');
                                    $gst_status_value = $fetch_room_data['gst_percentage'];
                                    $breakfast_included = $fetch_room_data['breakfast_included'];
                                    $lunch_included = $fetch_room_data['lunch_included'];
                                    $dinner_included = $fetch_room_data['dinner_included'];
