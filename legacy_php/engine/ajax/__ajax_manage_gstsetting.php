...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) : //CHECK AJAX REQUEST
    ...
    if ($_GET['type'] == 'add') :
        ...
        if (empty($_POST['gst_title'])) :
            $errors['gst_title_required'] = '<div class="alert alert-left alert-warning  mt-3" role="alert"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class="mx-2"><g><path fill="#f16a1b" d="M57.362 26.54 20.1 91.075a7.666 7.666 0 0 0 6.639 11.5h74.518a7.666 7.666 0 0 0 6.639-11.5L70.638 26.54a7.665 7.665 0 0 0-13.276 0z" data-original="#ffb400" opacity="1"></path><g fill="#fcf4d9"><rect width="9.638" height="29.377" x="59.181" y="46.444" rx="4.333" fill="#fcf4d9" data-original="#fcf4d9"></rect><circle cx="64" cy="87.428" r="4.819" fill="#fcf4d9" data-original="#fcf4d9"></circle></g></g></svg>Please Enter GST Title !!!</div>';
        elseif (($_POST['gst_value']) == "") :
            $errors['gst_value_required'] = '<div class="alert alert-left alert-warning  mt-3" role="alert"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class="mx-2"><g><path fill="#f16a1b" d="M57.362 26.54 20.1 91.075a7.666 7.666 0 0 0 6.639 11.5h74.518a7.666 7.666 0 0 0 6.639-11.5L70.638 26.54a7.665 7.665 0 0 0-13.276 0z" data-original="#ffb400" opacity="1"></path><g fill="#fcf4d9"><rect width="9.638" height="29.377" x="59.181" y="46.444" rx="4.333" fill="#fcf4d9" data-original="#fcf4d9"></rect><circle cx="64" cy="87.428" r="4.819" fill="#fcf4d9" data-original="#fcf4d9"></circle></g></g></svg>Please Enter GST !!!</div>';
        elseif (($_POST['cgst_value']) == "") :
            $errors['cgst_value_required'] = '<div class="alert alert-left alert-warning  mt-3" role="alert"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class="mx-2"><g><path fill="#f16a1b" d="M57.362 26.54 20.1 91.075a7.666 7.666 0 0 0 6.639 11.5h74.518a7.666 7.666 0 0 0 6.639-11.5L70.638 26.54a7.665 7.665 0 0 0-13.276 0z" data-original="#ffb400" opacity="1"></path><g fill="#fcf4d9"><rect width="9.638" height="29.377" x="59.181" y="46.444" rx="4.333" fill="#fcf4d9" data-original="#fcf4d9"></rect><circle cx="64" cy="87.428" r="4.819" fill="#fcf4d9" data-original="#fcf4d9"></circle></g></g></svg>Please Enter CGST !!!</div>';
        elseif (($_POST['sgst_value']) == "") :
            $errors['sgst_value_required'] = '<div class="alert alert-left alert-warning  mt-3" role="alert"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class="mx-2"><g><path fill="#f16a1b" d="M57.362 26.54 20.1 91.075a7.666 7.666 0 0 0 6.639 11.5h74.518a7.666 7.666 0 0 0 6.639-11.5L70.638 26.54a7.665 7.665 0 0 0-13.276 0z" data-original="#ffb400" opacity="1"></path><g fill="#fcf4d9"><rect width="9.638" height="29.377" x="59.181" y="46.444" rx="4.333" fill="#fcf4d9" data-original="#fcf4d9"></rect><circle cx="64" cy="87.428" r="4.819" fill="#fcf4d9" data-original="#fcf4d9"></circle></g></g></svg>Please Enter SGST !!!</div>';
        elseif (($_POST['igst_value']) == "") :
            $errors['igst_value_required'] = '<div class="alert alert-left alert-warning  mt-3" role="alert"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="24" height="24" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class="mx-2"><g><path fill="#f16a1b" d="M57.362 26.54 20.1 91.075a7.666 7.666 0 0 0 6.639 11.5h74.518a7.666 7.666 0 0 0 6.639-11.5L70.638 26.54a7.665 7.665 0 0 0-13.276 0z" data-original="#ffb400" opacity="1"></path><g fill="#fcf4d9"><rect width="9.638" height="29.377" x="59.181" y="46.444" rx="4.333" fill="#fcf4d9" data-original="#fcf4d9"></rect><circle cx="64" cy="87.428" r="4.819" fill="#fcf4d9" data-original="#fcf4d9"></circle></g></g></svg>Please Enter IGST !!!</div>';
        endif;
        //SANITIZE
        $sanitize_gst_title = $validation_globalclass->sanitize($_POST['gst_title']);
        $sanitize_gst_value = $validation_globalclass->sanitize($_POST['gst_value']);
        $sanitize_cgst_value = $validation_globalclass->sanitize($_POST['cgst_value']);
        $sanitize_sgst_value = $validation_globalclass->sanitize($_POST['sgst_value']);
        $sanitize_igst_value = $validation_globalclass->sanitize($_POST['igst_value']);
        $hiddenGST_ID = $validation_globalclass->sanitize($_POST['hiddenGST_ID']);
        ...
        if (!empty($errors)) :
            ...
            $arrFields = array('`gst_title`', '`gst_value`', '`cgst_value`', '`sgst_value`', '`igst_value`', '`createdby`', '`status`');
            $arrValues = array("$sanitize_gst_title", "$sanitize_gst_value", "$sanitize_cgst_value", "$sanitize_sgst_value", "$sanitize_igst_value", "$logged_user_id", "1");

            if ($hiddenGST_ID != '' && $hiddenGST_ID != 0 && (!empty($hiddenGST_ID))) :
                $sqlwhere = " `gst_setting_id` = '$hiddenGST_ID' ";

                //UPDATE HOTEL CATEGORY INFO
                if (sqlACTIONS("UPDATE", "dvi_gst_setting", $arrFields, $arrValues, $sqlwhere)) :
                    //SUCCESS
                ...
                if (sqlACTIONS("INSERT", "dvi_gst_setting", $arrFields, $arrValues, '')) :
                    //SUCCESS
                    $response['result'] = true;
    ...
    elseif ($_GET['type'] == 'updatestatus') :
        ...
        $GST_SETTING_ID = $_POST['GST_SETTING_ID'];
        $STATUS_ID = $_POST['STATUS_ID'];

        //SANITIZE
        $GST_SETTING_ID = $validation_globalclass->sanitize($GST_SETTING_ID);
        ...
        $sqlwhere = " `gst_setting_id` = '$GST_SETTING_ID' ";
    ...
    elseif ($_GET['type'] == 'delete') :
        ...
        $select_gst_setting_id_already_used = sqlQUERY_LABEL("SELECT COUNT(`gst_percentage`) AS TOTAL_USED_COUNT FROM `dvi_hotel_rooms` WHERE `gst_percentage` = '$ID' and `deleted` = '0'") or die("#1-UNABLE_TO_COLLECT_DETAILS:" . sqlERROR_LABEL());
            ...
            <div class="row">
                <?php if ($TOTAL_USED_COUNT == 0) : ?>
                    ...
                    <div class="text-center pb-0">
                        ...
                        <button type="submit" onclick="confirmGSTSETTINGDELETE('<?= $ID; ?>');" class="btn btn-danger">Delete</button>
                    </div>
                <?php else : ?>
                    <div class="text-center">
...
<?php
    elseif ($_GET['type'] == 'confirmdelete') :
        ...
        $delete_GST = sqlQUERY_LABEL("UPDATE `dvi_gst_setting` SET `deleted` = '1', `updatedon` = '" . date('Y-m-d H:i:s') . "' WHERE `gst_setting_id` = '$_ID'") or die("#1-UNABLE_TO_DELETE_GST:" . sqlERROR_LABEL());
