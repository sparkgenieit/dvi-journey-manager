                                                                    ...
                                                                    <div class="tab-pane fade show active">
                                                                        ...
                                                                        ?>
                                                                                <div class=" d-flex align-items-center justify-content-between gap-2 mb-2 pe-0">
                                                                                    ...
                                                                                    <h5 class="card-header px-0 py-0 mb-2 text-uppercase"><strong>Guide Details</strong></h5>
                                                                                    <!-- <span class="text-heading fw-bold">Defect Type : </span>-->
                                                                                    <select id="guide_defect_type" name="guide_defect_type[]" class="form-control form-select w-px-250">
                                                                                        <?= getCNCELLATION_DEFECT_TYPE($selected_type_id, 'select') ?>
                                                                                    </select>
                                                                                </div>
                                                                                ...
                                                                                <div id="guide">
                                                                                    ...
                                                                                    <div class="ms-4 mt-2">
                                                                                        ...
                                                                                        ?>
                                                                                                <div class="d-flex align-items-center mb-1 justify-content-between">
                                                                                                    <h6 class="m-0">
                                                                                                        <span><input class="form-check-input me-2
                                                                                                        guide-rate-checkbox guide-rate-checkbox_<?= $itinerary_route_ID ?>" type="checkbox"></span>
                                                                                    ...
                                                                                    <div id="div_guide_cancellation_charge" class="d-flex align-items-center justify-content-between mb-3 mt-2">
                                                                                        <div class=" d-flex align-items-center justify-content-end gap-2 mb-0 pe-0">
                                                                                            <span class=" text-heading fw-bold">Cancellation % : </span>
                                                                                            <input type="text" name="guide_cancellation_percentage[]" id="day_wise_guide_cancellation_percentage_<?= $itinerary_route_ID ?>" class="form-control required-field w-px-100 py-1 day_wise_guide_cancellation_percentage" style="width: 33%;" placeholder="cancel %" value="<?= $entire_itinerary_cancellation_percentage ?>">
                                                                                        </div>
                                                                                        <div class="text-end">
                                                                            ...
                                                                            if ($total_itinerary_plan_route_hotspot_details_count > 0) : ?>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class=" d-flex align-items-center justify-content-between gap-2 mb-2 pe-0">
                                                                                        ...
                                                                                        <!-- <span class="text-heading fw-bold">Defect Type : </span>-->
                                                                                        <select id="hotspot_defect_type" name="hotspot_defect_type[]" class="form-control form-select w-px-250">
                                                                                            <?= getCNCELLATION_DEFECT_TYPE($selected_type_id, 'select') ?>
                                                                                        </select>
                                                                                    </div>
                                                                                            ...
                                                                                            <div id="hotspot1">
                                                                                                ...
                                                                                                <div class="ms-4 mt-2">
                                                                                                    ...
                                                                                                    ?>
                                                                                                            <div class="d-flex align-items-center mb-1 justify-content-between">
                                                                                                                <h6 class="m-0">
                                                                                                                    <span><input class="form-check-input me-2 hotspot_rate_checkbox hotspot_rate_checkbox_<?= $itinerary_route_ID ?> hotspot_rate_checkbox_<?= $itinerary_route_ID ?>_<?= $route_hotspot_ID ?>" id="hotspot_rate_checkbox_<?= $itinerary_plan_ID ?>_<?= $itinerary_route_ID ?>_<?= $route_hotspot_ID ?>_<?= $hotspot_cost_detail_id ?>" type="checkbox"></span>
                                                                                                ...
                                                                                                <?php if ($hotspot_amout > 0): ?>
                                                                                                    <div class="d-flex align-items-center justify-content-between my-3">
                                                                                                        <div class=" d-flex align-items-center justify-content-end gap-2 mb-0 pe-0">
                                                                                                            <span class="text-heading fw-bold">Cancellation % : </span>
                                                                                                            <input type="text" name="hotspot_cancellation_charge[]" id="day_wise_hotspot_cancellation_percentage_<?= $itinerary_route_ID ?>_<?= $route_hotspot_ID ?>" class="form-control required-field w-px-100 py-1 hotspot_cancellation_percentage_input" style="width: 33%;" placeholder="cancel %" value="<?= $entire_itinerary_cancellation_percentage ?>" max="100" min="0" data-route_id="<?= $itinerary_route_ID ?>" data-route_hotspot_id="<?= $route_hotspot_ID ?>">
                                                                                                        </div>
                                                                                                        <div class="text-end">
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class=" d-flex align-items-center justify-content-between gap-2 mb-2 pe-0">
                                                                                    ...
                                                                                    <select id="activity_defect_type" name="activity_defect_type[]" class="form-control form-select w-px-250">
                                                                                        <?= getCNCELLATION_DEFECT_TYPE($selected_type_id, 'select') ?>
                                                                                    </select>
                                                                                </div>
                                                                                        ...
                                                                                        <div id="activity">
                                                                                            ...
                                                                                            <div class="ms-4 mt-2">
                                                                                                ...
                                                                                                ?>
                                                                                                        <div class="d-flex align-items-center mb-1 justify-content-between">
                                                                                                            <h6 class="m-0">
                                                                                                                <span><input class="form-check-input me-2 activity-rate-checkbox activity-rate-checkbox_<?= $itinerary_route_ID ?> activity-rate-checkbox_<?= $itinerary_route_ID ?>_<?= $route_activity_ID ?>" id="activity-rate-checkbox_<?= $itinerary_plan_ID ?>_<?= $itinerary_route_ID ?>_<?= $route_activity_ID ?>_<?= $activity_cost_detail_id ?>" type="checkbox"></span>
                                                                                            ...
                                                                                            <div class="d-flex align-items-center justify-content-between my-3">
                                                                                                <div class=" d-flex align-items-center justify-content-end gap-2 mb-0 pe-0">
                                                                                                    <span class="text-heading fw-bold">Cancellation % : </span>
                                                                                                    <input type="text" name="activity_cancellation_charge[]" id="day_wise_activity_cancellation_percentage_<?= $itinerary_route_ID ?>_<?= $route_activity_ID ?>" class="form-control required-field w-px-100 py-1 activity_cancellation_percentage_input" style="width: 33%;" placeholder="cancel %" value="<?= $entire_itinerary_cancellation_percentage ?>" max="100" min="0" data-route_id="<?= $itinerary_route_ID ?>" data-route_activity_id="<?= $route_activity_ID ?>">
                                                                ...
                                                                <div class="w-100 itinerary_daywise_list_tab bg-white py-3">
                                                                    <div class="row">
                                                                        <div class="col-sm-8 col-md-8 col-xxl-8 d-flex align-items-center">
                                                                            <h6 class="mb-0"><span><input class="form-check-input mx-2 hotel-checkbox hotel_checkbox_<?= $itinerary_plan_hotel_details_ID ?>" type="checkbox" data-hotel_details_id="<?= $itinerary_plan_hotel_details_ID ?>"></span>
                                                                    ...
                                                                    <div class="col-12 mt-2 mb-3">
                                                                        <div class="tab-pane fade show active">
                                                                            <div class=" d-flex align-items-center justify-content-end gap-2 mb-4 pe-0">
                                                                                <span class="text-heading fw-bold">Defect Type : </span>
                                                                                <select id="hotel_defect_type" name="hotel_defect_type[]" class="form-control form-select w-px-200">
                                                                                    <?= getCNCELLATION_DEFECT_TYPE($selected_type_id, 'select') ?>
                                                                                </select>
                                                                            </div>
                                                ...
                                                ?>
                                                            <tr>
                                                                <td style="max-width: 60px;">
                                                                    ...
                                                                    <input class="form-check-input me-2 vehicle_rate_checkbox vehicle_rate_checkbox_<?= $itinerary_plan_vendor_eligible_ID ?>" type="checkbox" data-vehicle_eligibility_id="<?= $itinerary_plan_vendor_eligible_ID ?>">
                                                                ...
                                                                <td colspan="1"><select id="vehicle_defect_type" name="vehicle_defect_type[]" class="form-control form-select w-px-200">
                                                                        <?= getCNCELLATION_DEFECT_TYPE($selected_type_id, 'select') ?>
                                                                    </select></td>
                                                                <td colspan="1">
                                                                    <input type="text" name="vehicle_cancellation_percentage[]" id="vehicle_cancellation_percentage" class="vehicle_cancellation_percentage vehicle_cancellation_percentage_<?= $itinerary_plan_vendor_eligible_ID ?> form-control required-field w-px-100 py-1 " style="width: 33%;" placeholder="cancel %" value="<?= ($entire_itinerary_cancellation_percentage != "") ?  $entire_itinerary_cancellation_percentage  : $nearest_cancellation_percentage ?>" data-vehicle_eligibility_id="<?= $itinerary_plan_vendor_eligible_ID ?>">
                                                                </td>
                                                                <td colspan="1">
