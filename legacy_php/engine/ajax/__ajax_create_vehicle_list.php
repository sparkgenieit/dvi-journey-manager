            ...
            <div class="col-md-12">
                <div class="card p-0">
                    <div class="card-header pb-3 d-flex justify-content-between">
                        ...
                        <div>
                            <a href="vendor.php?route=add&formtype=branch_list&id=10" type="button" class="btn btn-secondary me-1">Back to Branch</a>
                            <a href="javascript:;" type="button" class="btn btn-label-primary waves-effect" onclick="showvehicleFORMSTEP1(<?= $branch_id; ?>,<?= $vendor_id ?>,0)"><i class="ti ti-plus ti-xs me-1"></i>Add vehicle </a>
                        </div>
                    </div>
