...
?>
			...
			<div id="preview_btn">
				<div class="row">
				  <div class="col-12 text-center">
					...
					<button class="btn btn-secondary" onclick="show_driver_invoice_details('edit')">
    ...
    <script>
		$(document).ready(function() {
			<?php if($TYPE == 'edit' && $ID != ''): ?>
				show_driver_invoice_details('edit');
			<?php else: ?>
				show_driver_invoice_details('preview');
			<?php endif; ?>
		});
	  
		function show_driver_invoice_details(type) {
			if(type == 'edit'){
