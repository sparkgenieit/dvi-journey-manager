                ...
                <div class="col-md-12">
                    <div class="card mb-4 p-4">
                            ...
                            ?>
                                    <div class="col-md-1  my-2">
                                        <div class="room-details-image-head">
                                            <img src="<?= BASEPATH; ?>uploads/activity_gallery/<?= $activity_image_gallery_name; ?>" class="room-details-shadow img-fluid cursor rounded" width="100px" height="100px" />
                                        </div>
                                    </div>
                                <?php endwhile;
                            else :
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <a href="activity.php?route=add&formtype=activity_feedback_review&ID=<?= $ACTIVITY_ID ?>" type="button" class="btn btn-secondary">Back</a>
                            <a href="activitydetails.php" class="btn btn-primary waves-effect waves-light">Submit</a>
                        </div>
                    </div>
                </div>
            </div>
