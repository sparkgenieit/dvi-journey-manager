                        ...
                        <table width="700" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: collapse; background-color:#fff;">
                            ...
                            ?>
                                    ...
                                    if ($group_type == $recommended1 || $group_type == $recommended2 ||  $group_type == $recommended3 ||  $group_type == $recommended4) : ?>
                                        ...
                                        <tr>
                                            <td>
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: collapse; background-color:#fff;">
                                                    ...
                                                    <?php
                                                    $select_itinerary_plan_vendor_vehicle_summary_data = sqlQUERY_LABEL("SELECT d1.itinerary_plan_vendor_vehicle_details_ID, d1.itinerary_plan_vendor_eligible_ID, d1.itinerary_route_date, d1.travel_type, d1.itinerary_route_location_from, d1.itinerary_route_location_to, d1.total_running_km, d1.total_running_time, d1.total_siteseeing_km, d1.total_siteseeing_time, d1.total_travelled_km, d1.total_travelled_time, d1.vehicle_rental_charges, d1.vehicle_toll_charges, d1.vehicle_parking_charges, d1.vehicle_driver_charges, d1.vehicle_permit_charges, d1.before_6_am_extra_time, d1.after_8_pm_extra_time, d1.before_6_am_charges_for_driver, d1.before_6_am_charges_for_vehicle, d1.after_8_pm_charges_for_driver, d1.after_8_pm_charges_for_vehicle, d1.total_vehicle_amount, d2.itinerary_plan_vendor_eligible_ID AS eligible_list_id, d2.itineary_plan_assigned_status, d2.vehicle_type_id, d2.total_vehicle_qty, d2.vendor_id, d2.outstation_allowed_km_per_day, d2.extra_km_rate, d2.vehicle_orign, d2.vehicle_id, d2.total_kms, d2.vendor_branch_id, d2.vehicle_gst_percentage, d2.vehicle_gst_amount, d2.vehicle_total_amount, d2.vendor_margin_percentage, d2.vendor_margin_gst_type, d2.vendor_margin_gst_percentage, d2.vendor_margin_amount, d2.vendor_margin_gst_amount, d2.total_extra_kms_charge, d2.vehicle_grand_total, d2.total_outstation_km, d2.total_allowed_kms, d2.total_extra_kms FROM dvi_itinerary_plan_vendor_vehicle_details d1 LEFT JOIN dvi_itinerary_plan_vendor_eligible_list d2 ON d1.itinerary_plan_vendor_eligible_ID = d2.itinerary_plan_vendor_eligible_ID WHERE d1.deleted = '0' AND d1.status = '1' AND d1.itinerary_plan_id = '$itinerary_plan_ID' AND d2.`itineary_plan_assigned_status` = '1' AND d2.deleted = '0' AND d2.status = '1'") or die("#3-UNABLE_TO_COLLECT_DETAILS:" . sqlERROR_LABEL());
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php
                                                        $select_itinerary_plan_vendor_vehicle_summary_data1 = sqlQUERY_LABEL("SELECT d1.itinerary_plan_vendor_vehicle_details_ID, d1.itinerary_plan_vendor_eligible_ID, d1.itinerary_route_date, d1.travel_type, d1.itinerary_route_location_from, d1.itinerary_route_location_to, d1.total_running_km, d1.total_running_time, d1.total_siteseeing_km, d1.total_siteseeing_time, d1.total_travelled_km, d1.total_travelled_time, d1.vehicle_rental_charges, d1.vehicle_toll_charges, d1.vehicle_parking_charges, d1.vehicle_driver_charges, d1.vehicle_permit_charges, d1.before_6_am_extra_time, d1.after_8_pm_extra_time, d1.before_6_am_charges_for_driver, d1.before_6_am_charges_for_vehicle, d1.after_8_pm_charges_for_driver, d1.after_8_pm_charges_for_vehicle, d1.total_vehicle_amount, d2.itinerary_plan_vendor_eligible_ID AS eligible_list_id, d2.itineary_plan_assigned_status, d2.itinerary_plan_id, d2.vehicle_type_id, d2.total_vehicle_qty, d2.vendor_id, d2.outstation_allowed_km_per_day, d2.extra_km_rate, d2.vehicle_orign, d2.vehicle_id, d2.total_kms, d2.vendor_branch_id, d2.vehicle_gst_percentage, d2.vehicle_gst_amount, d2.vehicle_total_amount, d2.vendor_margin_percentage, d2.vendor_margin_gst_type, d2.vendor_margin_gst_percentage, d2.vendor_margin_amount, d2.vendor_margin_gst_amount, d2.total_extra_kms_charge, d2.vehicle_grand_total, d2.total_outstation_km, d2.total_allowed_kms, d2.total_extra_kms FROM dvi_itinerary_plan_vendor_vehicle_details d1 LEFT JOIN  dvi_itinerary_plan_vendor_eligible_list d2 ON d1.itinerary_plan_vendor_eligible_ID = d2.itinerary_plan_vendor_eligible_ID WHERE d1.deleted = '0' AND d1.status = '1' AND d1.itinerary_plan_id =  '$itinerary_plan_ID' AND d2. `itineary_plan_assigned_status` = '1' AND d2.deleted = '0' AND d2.status = '1' GROUP BY d2.vehicle_type_id") or die("#3-UNABLE_TO_COLLECT_DETAILS:" . sqlERROR_LABEL());
                                        ...
                                        // Apply additional margin to total components amount
                                        $total_components_amount += $additional_margin;
                                            ...
                                            <td>
                                                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: collapse; background-color:#fff;">
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <?php $cwb_cost = (getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $group_type, 'TOTAL_CWB_COST'));
                                                        // Check if additional margin needs to be applied
                                                        if ($no_of_days <= $itinerary_additional_margin_day_limit) {
                                                            // Calculate additional margin
                                                        ...
                                                        <?php endif; ?>
                                                        <?php $cnb_cost = (getHOTEL_SUMMARYITINEARY_PLAN_DETAILS($itinerary_plan_ID, $group_type, 'TOTAL_CNB_COST'));
                                                        // Check if additional margin needs to be applied
                                                        if ($no_of_days <= $itinerary_additional_margin_day_limit) {
                                                            // Calculate additional margin
                                                    ...
                                                    <?php endif; ?>
                                                    <?php $activity_cost = getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_activity_amout') + $separate_service_amount;
                                                    // Check if additional margin needs to be applied
                                                    if ($no_of_days <= $itinerary_additional_margin_day_limit) {
                                                        // Calculate additional margin
                                                    ...
                                                    <!--  <?php if (in_array($itinerary_preference, array(2, 3))) : ?>
                                                        <?php $vehicle_cost = (getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, '', 'total_confirmed_vendor_vehicle_amount', '') + getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, '', 'total_vendor_margin_amount', '') + getITINEARY_NEWOVERALLCOST_DETAILS($itinerary_plan_ID, '', 'total_vendor_tax_amount'));
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left; padding: 3px; border: 1px solid #b1b1b1;">
                                                                    <?= general_currency_symbol . ' ' . number_format(($vehicle_cost), 2); ?>
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
                                            ...
                                            ?>
                                                ...
                                                if (sqlNUMOFROW_LABEL($select_itinerary_plan_vendor_vehicle_summary_data1) > 0) :
                                                    while ($fetch_eligible_vendor_vehicle_data1 = sqlFETCHARRAY_LABEL($select_itinerary_plan_vendor_vehicle_summary_data1)) :
                                                        ...
                                                        $vehicle_type_title = totalkms($vehicle_type_id, 'vehicle_type');
                                                        $totalamount = (getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_vehicle_amount', $vehicle_type_id));
                                                        $totalamount = $totalamount + $additional_margin_per_vehicle;
                                                        // Check if additional margin needs to be applied
                                                        if ($no_of_days <= $itinerary_additional_margin_day_limit) {
                                                            // Calculate additional margin
                                                            $totalamount_additional_margin = ($itinerary_additional_margin_percentage * $totalamount) / 100;
                            ...
                            if ($itinerary_preference != 1) : ?>
                                    ...
                                    <td colspan="4" style="border: 1px solid #b1b1b1; padding: 4px; font-size: 11px; background-color: #f2f2f2;">
                                        <div style="display: flex; align-items: center;">
                                            <span style="margin-right: 4px; font-weight: 400;color: #302c6e;">
                                                <strong style="color: #302c6e;">Day <?= $itineary_route_count; ?></b> - <?= date('D, M d, Y', strtotime($itinerary_route_date)); ?> (<?= date('h:i A', strtotime($route_start_time)); ?> - <?= date('h:i A', strtotime($route_end_time)); ?>) - <span style="color: #302c6e;"><?= $location_value; ?> <?= $via_route_details; ?> <?= $next_visiting_value; ?> - (<?= number_format(get_ASSIGNED_VEHICLE_ITINEARY_PLAN_DAYWISE_KM_DETAILS($itinerary_plan_ID, $itinerary_route_ID, 'get_total_kms'), 2); ?> KM)</strong>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <tr>
                                        <td colspan="4" style="border: 1px solid #b1b1b1; padding: 4px; font-size: 11px;">
                                            <div style="color: #302c6e;">
                                                <span style="margin-right: 4px;"><b>About Location: </b><?= $location_description; ?></span>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                                ...
                                ?>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td colspan="4" style="border: 1px solid #b1b1b1; padding: 4px; font-size: 11px;">
                                                <div style="color: #302c6e;">
                                                    <span style="margin-right: 4px;">Day Trip is Available</span>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                            ...
                                            <div style="color: #302c6e;">
                                                <?php if (trim($arrival_location) == trim($location_name) && $itineary_route_count == 1): ?>
                                                    <span style="margin-right: 4px;">
                                                        <?= getGLOBALSETTING('itinerary_break_time'); ?></span><?php else: ?>
                                                    <?= getGLOBALSETTING('itinerary_hotel_start'); ?>
                                                <?php endif; ?><span> <?= date('h:i A', strtotime($hotspot_start_time)); ?> - <?= date('h:i A', strtotime($hotspot_end_time)); ?></span>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <?php if ($item_type == 2) : ?>
                                    <tr>
                                        <td colspan="4" style="border: 1px solid #b1b1b1; padding: 4px; font-size: 11px;">
                                            <div style="color: #302c6e;">
                                                <div><span style="margin-right: 4px;">Travelling from <?= $location_name; ?> to <?= getITINEARYROUTE_DETAILS($itinerary_plan_ID, $itinerary_route_ID, 'next_visiting_location'); ?></span> - <span><?= date('h:i A', strtotime($hotspot_start_time)); ?> - <?= date('h:i A', strtotime($hotspot_end_time)); ?></span> [<span style="color: #7e7d88; margin-right: 5px;">Distance:</span> <?= $hotspot_travelling_distance; ?> KM, <span style="color: #7e7d88; margin: 0px 5px;">Duration:</span> <?= formatTimeDuration($hotspot_traveling_time); ?> ]</div>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                                ...
                                ?>
                                    <?php if ($allow_break_hours == 1): ?>
                                        <tr>
                                            <td colspan="4" style="border: 1px solid #b1b1b1; padding: 4px; font-size: 11px;">
                                                <div style="color: #302c6e;">
                                                    <div><span style="margin-right: 4px;">Expect a waiting time of approximately <b><?= formatTimeDuration($hotspot_traveling_time); ?></b> at this location <?= $to_hotspot_name; ?></span> - <span><?= date('h:i A', strtotime($hotspot_start_time)); ?> - <?= date('h:i A', strtotime($hotspot_end_time)); ?></span> [<span style="color: #7e7d88; margin: 0px 5px;">Duration:</span> <?= formatTimeDuration($hotspot_traveling_time); ?> ]</div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <?php if ($item_type == 5) : ?>
                                    <tr>
                                        <td colspan="4" style="border: 1px solid #b1b1b1; padding: 4px; font-size: 11px;">
                                            <div style="color: #302c6e;">
                                                <div><span style="margin-right: 4px;">Travelling from <?= $previous_hotspot_name; ?> to <?= getITINEARYROUTE_DETAILS($itinerary_plan_ID, $itinerary_route_ID, 'next_visiting_location'); ?></span> - <span><?= date('h:i A', strtotime($hotspot_start_time)); ?> - <?= date('h:i A', strtotime($hotspot_end_time)); ?></span> [<span style="color: #7e7d88; margin-right: 5px;">Distance:</span> <?= $hotspot_travelling_distance; ?> KM, <span style="color: #7e7d88; margin: 0px 5px;">Duration:</span> <?= formatTimeDuration($hotspot_traveling_time); ?> ]</div>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endif; ?>
