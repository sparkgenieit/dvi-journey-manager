                            ...
                            <div class="col-md-12">
                                <div class="card p-0">
                                    <div class="card-header pb-3 d-flex justify-content-between">
                                        ...
                                        <a id="btn_limelimit" href="javascript:void(0)" class="btn btn-label-primary waves-effect" onclick="showTIMELIMITMODAL(0);" data-bs-dismiss="modal">+ Add Local KM Limit</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#time_limit_LIST').DataTable({
                ...
                ajax: {
                    "url": "engine/json/__JSONtimelimit.php",
                    "type": "GET"
                },
                columns: [{
                        data: "count"
        ...
        //ADD & DELETE MODAL
        function showTIMELIMITMODAL(TIME_LIMIT_ID) {
            $('.receiving-time-limit-form-data').load('engine/ajax/__ajax_add_timelimit.php?type=show_form&TIME_LIMIT_ID=' + TIME_LIMIT_ID + '', function() {
        ...
        //SHOW DELETE POPUP
        function showDELETETIMELIMITMODAL(ID) {
            $('.receiving-confirm-delete-form-data').load('engine/ajax/__ajax_manage_timelimit.php?type=delete&ID=' + ID, function() {
        ...
        function confirmTIMELIMITDELETE(ID) {
            $.ajax({
                type: "POST",
