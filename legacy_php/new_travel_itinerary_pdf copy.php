...
class TCPDFCustom extends TCPDF
{
    public function Header()
    {
        ...
        $logoPath = 'http://localhost/dvi_travels/head/assets/img/logo-preview.png';
        $logoWidth = 23;
...
<span style="font-size: 14px; vertical-align: middle;color:#fff;">Over All Package Cost: <span style="font-family:DejaVuSans;">' . general_currency_symbol . '</span> ' . number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'itineary_gross_total_amount') + $TOTAL_ITINEARY_GUIDE_CHARGES, 2) . '</span>
...
if ($select_itinerary_route_details_count > 0) :
    while ($fetch_itineary_route_data = sqlFETCHARRAY_LABEL($select_itinerary_route_details)) :
        ...
        $select_itinerary_via_route_list_query = sqlQUERY_LABEL("SELECT `itinerary_via_route_ID`, `itinerary_route_ID`, `itinerary_plan_ID`, `itinerary_route_date`, `source_location`, `destination_location`, `itinerary_via_location_name` FROM `dvi_itinerary_via_route_details` WHERE `deleted` = '0' AND `status` = '1'  AND `itinerary_plan_ID` = '$itinerary_plan_ID' AND `itinerary_route_ID` = '$itinerary_route_ID'") or die("#1-UNABLE_TO_ITINEARY_ROUTE_VIA_LOCATION_LIST:" . sqlERROR_LABEL());
...
if ($itinerary_plan_hotel_group_query_count > 0) :
    while ($row_hotel_group = sqlFETCHARRAY_LABEL($itinerary_plan_hotel_group_query)) :
        ...
        if ($itinerary_preference == 3) :
                    ...
                    if ($select_room_details_count > 0) :
                        while ($fetch_room_data = sqlFETCHARRAY_LABEL($select_room_details)) :
                            ...
                            if ($itinerary_plan_hotel_room_count > 0) :
                                while ($row_hotel_room_count = sqlFETCHARRAY_LABEL($itinerary_plan_hotel_room)) :
                                    ...
                                    $room_gallery = getROOM_GALLERY_DETAILS($hotel_ID, $room_ID, '', 'get_room_gallery_1st_IMG');

                                    if ($room_gallery  == '') :
                                        $room_gallery_data = 'assets/img/no-image-found.png';
                                    else :
                                        $room_gallery_data = 'uploads/room_gallery/' . $room_gallery . '';
                                    endif;
                                    ...
                                    $tbl_details .= '
                                        ...
                                        <br/><br/>
                                            ...
                                            <table align="center"  valign="middle" border="0" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="20%"><b>Room #' . $room_count . '</b></td>
                                                        <td align="left" width="80%"><b>- ' . $room_type_name . '</b></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            </div>
                        ...
                        if ($total_room_cost != '0'):
                            $tbl_details .= '
                                    ...
                                    <span style="font-family:DejaVuSans;">' . general_currency_symbol . '</span> ' . $total_room_cost . '
                                    </td>
                                </tr>';
                        endif;
            ...
            $select_itinerary_vehicle_route_query = sqlQUERY_LABEL("SELECT `itinerary_plan_vendor_eligible_ID`, `vehicle_type_id`, `total_vehicle_qty` FROM `dvi_itinerary_plan_vendor_eligible_list` WHERE `deleted` = '0' and `itinerary_plan_ID` = '$itinerary_plan_ID' and `itineary_plan_assigned_status` = '1'") or die("#1-UNABLE_TO_COLLECT_HOTEL_LIST:" . sqlERROR_LABEL());
                    ...
                    <table cellspacing="0" cellpadding="8" border="1">
                        ...
                        <br/><br/>
                            ...
                            <table align="center"  valign="middle" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td align="left" width="100%"><b>' . $vendor_vehicle . ' - ' . $vehicle_name . '</b></td>
                                    </tr>
                                </tbody>
                            </table>
                            </div>
                            ...
                            <tbody>
                                <tr>
                                    <td width="15%">
                                        <img data-image="Icon 5" src="assets/img/exterior (1).jpg"alt="Icon" width="110px" border="0" style="width:110px;height:110px;border:1px solid #fff;display:inline-block !important;">
                                    </td>
                                    <td width="85%">
                                        <table align="center"  valign="middle" border="0" cellpadding="0" cellspacing="0">
                                            <tbody>
                        ...
                        Gross Total for the Day #1 [' . $vehicle_name . ']
                        </td>
                ...
                while ($fetch_itinerary = sqlFETCHARRAY_LABEL($select_itinerary_vehicle_route_query)) :
                    ...
                    $tbl_details .= '<tr style="color:#333; font-size: 14px;">
                        ...
                        <tr style="color:#fff;font-size:14px;background-color:RGB(0, 0, 128);">
                            ...
                            <td align="right" width="19%">
                                <span style="font-weight: bold;">' . $total_vehicle_qty . ' * <span style="font-family:DejaVuSans;">' . general_currency_symbol . '</span>' . number_format($vehicle_grand_total, 2) . '</span>
                            </td>
                            <td align="right" width="19%">
                                <span style="font-weight: bold;"><span style="font-family:DejaVuSans;">' . general_currency_symbol . '</span> ' . number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_vehicle_amount'), 2) . '</span>
                            </td>
                        </tr>
                </table>';
                endwhile;
            ...
            $total_hotspot_charge = number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_hotspot_amount'), 2);
            $total_activity_charge = number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_activity_amout'), 2);
            $total_guide_charge = number_format($TOTAL_ITINEARY_GUIDE_CHARGES, 2);
            $total_hotel_charge = number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, $group_type, 'total_hotel_amount'), 2);
            $total_vehicle_charge = number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_vehicle_amount'), 2);

            $tbl_details .=
                '<table cellspacing="0" cellpadding="8" border="1">';
            if ($total_hotspot_charge != '0'):
                $tbl_details .= '<tr style="font-size: 14px; font-weight:bold;">
                            <td width="50%">
            ...
            $tbl_details .= '<table  cellspacing="0" cellpadding="8" border="1"><tr><td colspan="3" align="center" style=" font-weight:bold; font-size: 12px;background-color:RGB(0, 0, 128);">
                <span style="font-size: 14px; vertical-align: middle;color:#fff;">Over All Package Cost: <span style="font-family:DejaVuSans;">' . general_currency_symbol . '</span> ' . number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, $group_type, 'itineary_gross_total_amount') + $TOTAL_ITINEARY_GUIDE_CHARGES, 2) . '</span>
                </td></tr></table>';
...
if ($itinerary_preference == 2) :
    ...
    $tbl_vehicledetails .=
        '<table cellspacing="0" cellpadding="8" border="1">';
    if ($total_hotspot_charge != '0'):
        $tbl_vehicledetails .= '<tr style="font-size: 14px; font-weight:bold;">
            <td width="50%">
                Total Hotspot Charges
            </td>
            <td align="right" width="50%">
    ...
    $tbl_vehicledetails .= '<table  cellspacing="0" cellpadding="8" border="1"><tr><td colspan="3" align="center" style=" font-weight:bold; font-size: 12px;background-color:RGB(0, 0, 128);">
    <span style="font-size: 14px; vertical-align: middle;color:#fff;">Over All Package Cost: <span style="font-family:DejaVuSans;">' . general_currency_symbol . '</span> ' . number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, $group_type, 'itineary_gross_total_amount') + $TOTAL_ITINEARY_GUIDE_CHARGES, 2) . '</span>
    </td></tr></table>';


    // -------------------------------------- COMPLETE DETAILS --------------------------------------- //
    $tbl_vehicledetails .= '<table  cellspacing="0" cellpadding="8" border="0">  <tr>
                    <td><span>&nbsp;</span></td>
                </tr></table>';
endif;
