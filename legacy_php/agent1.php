...
<body>
                        ...
                        <div class="row mb-5">
                            <div class="col-xl-12">
                                <div class="tabbed round" id="skinable">
                                    <ul class="p-0">
                                        <li data-tab="tab1" class="active">Route 1</li>
                                        <li data-tab="tab2">Route 2</li>
                                        <li data-tab="tab3">Route 3</li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content" id="tab2-content" style="display:none;">
                                    <h2 class="tab-title">Content for Second Tab</h2>
                                    <p>This is the content displayed in the second tab.</p>
                                </div>
                                <div class="tab-content" id="tab3-content" style="display:none;">
                                    <h2 class="tab-title">Content for Third Tab</h2>
                                    <p>This is the content displayed in the third tab.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var tabs = document.querySelectorAll('#skinable ul li'); // Updated selector for tabs
            var contents = document.querySelectorAll('.tab-content'); // Select all tab content
            ...
            for (var i = 0; i < tabs.length; i++) {
                tabs[i].addEventListener("click", function() {
                    ...
                    var tabId = this.getAttribute('data-tab'); // Get data attribute
                    document.getElementById(tabId + '-content').style.display = 'block'; // Show content
                });
            }
        });
    </script>
