...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <span id="VOUCHER_CANCELLATION_DETAILS"></span>
    ...
    <script>
        $(document).ready(function() {
            showVOUCHER_CANCELLATION_DETAILS('<?= $itinerary_plan_ID; ?>');
        });

        function showVOUCHER_CANCELLATION_DETAILS(itinerary_plan_ID) {
            $.ajax({
                type: "POST",
                url: "engine/ajax/ajax_confirmed_itinerary_hotel_voucher_cancellation_details.php?type=show_form",
                data: {
                    _itinerary_plan_ID: itinerary_plan_ID,
                },
                success: function(response) {
                    $('#VOUCHER_CANCELLATION_DETAILS').html('');
                    $('#VOUCHER_CANCELLATION_DETAILS').html(response);
                }
            });
        }
    </script>
