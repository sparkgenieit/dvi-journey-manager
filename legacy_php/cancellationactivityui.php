                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body rounded-0">
                                            ...
                                            <!-- Hotspot Name and Total Cost -->
                                            <div class="d-flex justify-content-between align-items-center mb-0">
                                                <h6 class="text-uppercase text-muted fw-bold" style="font-size: 1.1rem;">
                                                    #1 Kapleswara Temple | Activities
                                                </h6>
                                                <span class="text-primary" style="font-size: 1.2rem; font-weight: bold;">₹ 12,000</span>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <!-- Activity 1 -->
                                                <div class="col-6">
                                                    <div class="accordion" id="activityAccordion1">
                                                        <div class="card accordion-item">
                                                            <h2 class="accordion-header" id="activityHeading1">
                                                                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#activityDetails1" aria-expanded="false" aria-controls="activityDetails1">
                                                                    <b>Activity 1: Temple Entry</b> - ₹ 6,500
                                                                </button>
                                                            </h2>
                                                            <div id="activityDetails1" class="accordion-collapse collapse" data-bs-parent="#activityAccordion1">
                                                                <div class="accordion-body">
                                                                    <!-- Adults Section -->
                                                                    <div class="border rounded p-3 mb-3">
                                                                        <h6 class="fw-bold mb-2 text-primary">Adults (5) - ₹ 3,000</h6>
                                                                        <?php for ($i = 1; $i <= 2; $i++): ?>
                                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                                <span style="color: #333; font-size: 0.9rem; font-weight: 500;">Adult <?= $i; ?></span>
                                                                                <span style="color: #212529; font-size: 0.9rem; font-weight: bold;">₹ 600</span>
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <select class="form-select form-select-sm ms-2" style="width: 120px;">
                                                                        ...
                                                                        <?php endfor; ?>
                                                                        <!-- Canceled Ticket -->
                                                                        <div class="mt-2 p-2" style="background-color: #ffeaea; border-left: 5px solid #dc3545; border-radius: 5px;">
                                                                            <span style="color: #495057; font-size: 0.9rem; font-weight: bold;">Adult 2 (Cancelled)</span>
                                                                            <p class="mb-0 mt-1" style="font-size: 0.8rem; color: #6c757d;">Cancelled on: 30 Dec, 2024 at 10:00 AM</p>
                                                                            <p class="mb-0" style="color: #6c757d; font-size: 0.85rem;"><strong>Original:</strong> ₹ 1,000 | <strong>Refund:</strong> ₹ 900 (10% Deduction)</p>
                                                                        </div>
                                                                    </div>

                                                                    <!-- Children Section -->
                                                                    <div class="border rounded p-3 mb-3">
                                                                        <h6 class="fw-bold mb-2 text-success">Children (3) - ₹ 1,800</h6>
                                                                        <?php for ($i = 1; $i <= 2; $i++): ?>
                                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                                <span style="color: #333; font-size: 0.9rem; font-weight: 500;">Child <?= $i; ?></span>
                                                                                <span style="color: #212529; font-size: 0.9rem; font-weight: bold;">₹ 600</span>
                                                                                <div class="d-flex align-items-center">
                                                                                    <label for="cancellation_child<?= $i; ?>" class="fw-bold me-1" style="color: #555; font-size: 0.85rem;">Cancellation %:</label>
                                                                                    <input type="number" id="cancellation_child<?= $i; ?>" min="0" max="100" class="form-control form-control-sm d-inline-block" style="width: 50px;" value="10">
                                                                                    <select class="form-select form-select-sm ms-2" style="width: 120px;">
                                                                                        <option value="not-available">Not Available</option>
                                                                                        <option value="time-issue">Time Conflict</option>
                                                                                        <option value="other">Other</option>
                                                                    ...
                                                                    <div class="border rounded p-3">
                                                                        <h6 class="fw-bold mb-3" style="color: #495057; font-size: 1rem; border-radius: 5px;">Infants (1) - ₹ 500</h6>
                                                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                                                            <span style="color: #333; font-size: 0.9rem; font-weight: 500;">Infant 1</span>
                                                                            <span style="color: #212529; font-size: 0.9rem; font-weight: bold;">₹ 500</span>
                                                                            <div class="d-flex align-items-center">
                                                                                <label for="cancellation_infant1" class="fw-bold me-1" style="color: #555; font-size: 0.85rem;">Cancellation %:</label>
                                                                                <input type="number" id="cancellation_infant1" min="0" max="100" class="form-control form-control-sm d-inline-block" style="width: 50px;" value="10">
                                                                                <select class="form-select form-select-sm ms-2" style="width: 120px;">
                                                                                    <option value="not-available">Not Available</option>
                                                                                    <option value="time-issue">Time Conflict</option>
                                                                                    <option value="other">Other</option>
                                                ...
                                                <div class="col-6">
                                                    <div class="accordion" id="activityAccordion1">
                                                        <!-- Activity Section -->
                                                        <div class="card accordion-item shadow-sm border-0 mb-3">
                                                            <h2 class="accordion-header" id="activityHeading1">
                                                                <button
                                                                    class="accordion-button collapsed"
                                                                    type="button"
                                                                    data-bs-toggle="collapse"
                                                                    data-bs-target="#activityDetails1"
                                                                    aria-expanded="false"
                                                                    aria-controls="activityDetails1">
                                                                    <div class="d-flex justify-content-between align-items-center w-100">
                                                                        <!-- Left: Activity Title and Indicators -->
                                                                        <div>
                                                                            <b style="font-size: 1rem;">Activity 1: Temple Entry</b>
                                                                        ...
                                                                        <div class="text-end">
                                                                            <div class="d-flex align-items-center gap-2">
                                                                                <span style="font-size: 0.85rem; color: #495057;">Status:</span>
                                                                                <span class="badge bg-warning text-dark" style="font-size: 0.85rem;">Partial Cancellation</span>
                                                                            </div>
                                                                            <small class="d-block text-muted" style="font-size: 0.85rem;">Total Cost</small>
                                                                            <b class="text-primary" style="font-size: 1rem;">₹ 6,500</b>
                                                                        </div>
                                                                    </div>
                                                                </button>
                                                            </h2>
                                                            ...
                                                            <div id="activityDetails1" class="accordion-collapse collapse" data-bs-parent="#activityAccordion1">
                                                                <div class="accordion-body">
                                                                    ...
                                                                    <div class="border rounded p-3 mb-3">
                                                                        ...
                                                                        <!-- Active Tickets -->
                                                                        <?php for ($i = 1; $i <= 2; $i++): ?>
                                                                            <div class="d-flex justify-content-between align-items-center p-2 border-bottom" style="gap: 10px;">
                                                                                <!-- Left: Ticket Details -->
                                                                                <div style="flex: 1; text-align: left;">
                                                                                    <p class="mb-0" style="color: #495057; font-size: 0.9rem; font-weight: 500;">Adult <?= $i; ?></p>
                                                                        ...
                                                                        <?php endfor; ?>
                                                                        <!-- Canceled Ticket -->
                                                                        <div class="p-2 mt-3" style="background-color: #ffeaea; border-left: 5px solid #dc3545; border-radius: 5px;">
                                                                            <p class="mb-0 fw-bold text-danger" style="font-size: 0.9rem;">Adult 3 (Cancelled)</p>
                                                                            <small class="text-muted d-block" style="font-size: 0.8rem;">Cancelled on: 30 Dec, 2024 at 10:00 AM</small>
                                                                            <small class="text-muted d-block" style="font-size: 0.8rem;">Refund: ₹ 540 (10% Deduction)</small>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="border rounded p-3 mb-3">
                                                                        ...
                                                                        <?php for ($i = 1; $i <= 2; $i++): ?>
                                                                            <div class="d-flex justify-content-between align-items-center p-2 border-bottom">
                                                                                <div>
                                                                                    <p class="mb-0" style="color: #495057; font-size: 0.9rem;">Child <?= $i; ?></p>
                                                                                    <small class="text-muted" style="font-size: 0.8rem;">Price: ₹ 600</small>
                                                                                </div>
                                                                                <div class="d-flex align-items-center">
                                                                                    <div>
                                                                                        <label class="mb-1 text-muted" style="font-size: 0.75rem;">Cancellation %</label>
                                                                                        <input type="number" min="0" max="100" class="form-control form-control-sm text-center" style="width: 70px;">
                                                                                    </div>
                                                                                    <div class="ms-2">
                                                                                        <label class="mb-1 text-muted" style="font-size: 0.75rem;">Defect Type</label>
                                                                    ...
                                                                    <!-- Infants Section -->
                                                                    <div class="border rounded p-3">
                                                                        <h6 class="fw-bold mb-3 text-secondary">Infants (1) - ₹ 500</h6>
                                                                        <div class="d-flex justify-content-between align-items-center">
                                                                            <div>
                                                                                <p class="mb-0" style="color: #495057; font-size: 0.9rem;">Infant 1</p>
                                                                                <small class="text-muted" style="font-size: 0.8rem;">Price: ₹ 500</small>
                                                                            </div>
                                                                            <div class="d-flex align-items-center">
                                                                                <div>
                                                                                    <label class="mb-1 text-muted" style="font-size: 0.75rem;">Cancellation %</label>
                                                ...
                                                <!-- Activity 2 -->
                                                <div class="col-6">
                                                    <div class="accordion" id="activityAccordion2">
                                                        <div class="card accordion-item">
                                                            <h2 class="accordion-header" id="activityHeading2">
                                                                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#activityDetails2" aria-expanded="false" aria-controls="activityDetails2">
                                                                    <b>Activity 2: Museum Visit</b> - ₹ 5,500
                                                                </button>
                                                            </h2>
                                                            <div id="activityDetails2" class="accordion-collapse collapse" data-bs-parent="#activityAccordion2">
                                                                <div class="accordion-body">
                                                                    <!-- Repeat Sections for Adults, Children, Infants -->
                                                                    <p>Activity-specific content goes here.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
