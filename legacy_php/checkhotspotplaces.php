...
?>
<iframe width="600" height="450" style="border:0;" loading="lazy" allowfullscreen="" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.088426042449!2d<?= $longitude; ?>!3d<?= $latitude; ?>!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a528b9fb1ba1bf3%3A0xa11a4606e13a1c98!2sQueensland%20Amusement%20Park!5e0!3m2!1sen!2sin!4v1702120545074!5m2!1sen!2sin"></iframe>

<!-- Map container -->
<iframe width="600" height="450" style="border:0;" loading="lazy" allowfullscreen="" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.088426042449!2d<?= $longitude; ?>!3d<?= $latitude; ?>!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1sen!2sin!4v1702120545074&&markers=<?= $latitude; ?>,<?= $longitude; ?>"></iframe>
...
function searchHotspotPlacesByTypes($location_name, $keywords, $types, $GOOGLEMAP_API_KEY)
{
    ...
    foreach ($types ?: [''] as $type) {
        ...
        do {
            ...
            $params = [
                'query' => $type . ' in ' . $location_name . ' name in ' . implode(' OR ', $keywords),
                'key' => $apiKey,
...
$typesToSearch = [''];
$location_name = ['Chennai, Tamil Nadu, India', 'Pondicherry, India', 'Mahabalipuram, Tamil Nadu, India'];
//$location_name = ['Pondicherry, India'];
$keywordsToFilter = ['Serenity beach', 'Kapaleeshwarar Temple'];

foreach ($location_name as $location) {
    $hotspotPlaces = searchHotspotPlacesByTypes($location, $keywordsToFilter, $typesToSearch, $GOOGLEMAP_API_KEY);
    // Append the results for the current location to the main array
    $allHotspotPlaces[$location] = $hotspotPlaces;
}
