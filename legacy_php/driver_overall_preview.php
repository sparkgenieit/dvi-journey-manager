                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class=" d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="font-weight-bold">Driver Preview</h4>
                            </div>
                            <div class="my-3">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Driver Preview</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="vehicle-overall-preview-type mb-4">
                            <span>Kumar - </span><span>TN67P1234</span>
                        </div>
                        ...
                        <div class="card mb-3 col-xl-12 col-lg-12 col-md-12 order-0 order-md-1 px-1">
                            <ul class="nav p-2 nav-pills card-header-pills " role="tablist">
                                ...
                                <li class="nav-item mx-2" role="presentation">
                                    <button type="button" class="nav-link shadow-none hotel_overall_preview_tap" role="tab" data-bs-toggle="tab" data-bs-target="#cost" aria-controls="cost" aria-selected="false" fdprocessedid="rkjecy" tabindex="-1">Cost</button>
                                </li>
                                <li class="nav-item mx-2" role="presentation">
                                    <button type="button" class="nav-link shadow-none hotel_overall_preview_tap" role="tab" data-bs-toggle="tab" data-bs-target="#gallery" aria-controls="gallery" aria-selected="false" fdprocessedid="dxymu" tabindex="-1">Uploaded Docs</button>
                                </li>
                                <li class="nav-item mx-2" role="presentation">
                                    <button type="button" class="nav-link shadow-none hotel_overall_preview_tap" role="tab" data-bs-toggle="tab" data-bs-target="#license_renewal_history" aria-controls="license_renewal_history" aria-selected="false" fdprocessedid="dxymu" tabindex="-1">License Renewal History</button>
                                </li>
                                <li class="nav-item mx-2" role="presentation">
                                    <button type="button" class="nav-link shadow-none hotel_overall_preview_tap" role="tab" data-bs-toggle="tab" data-bs-target="#feedbackreview" aria-controls="feedbackreview" aria-selected="false" fdprocessedid="dxymu" tabindex="-1">Feedback & Review</button>
                                </li>
                            </ul>
                        ...
                        <div class="">
                            <div class="tab-content p-0" id="pills-tabContent">
                                <div class="tab-pane card p-4 mb-3 fade show active" id="basic_info" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <div class="row">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="#"> <i class="tf-icons ti ti-edit"></i>
                                        ...
                                        <div class="col-md-3 rounded-circle">
                                            <div class="wrapper mb-3">
                                                ...
                                                <img src="../head/assets/img/profile.jpg" class="driver-profile">
                                            </div>
                                        </div>
                                        <div class="col-md-3 mt-4">
                                            <label>Aadharcard Number</label>
                                            <p class="text-light">9028020929</p>
                                        </div>
                                        <div class="col-md-3 mt-4">
                                            <label>Primary Mobile Number </label>
                                            <p class="text-light">9087362323</p>
                                        </div>
                                        <div class="col-md-3 mt-4">
                                            <label>Alternative Mobile Number</label>
                                            <p class="text-light">8790765722</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>Vendor Name</label>
                                            <p class="text-light">ABCD</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>License Expire Date</label>
                                            <p class="text-light">12-08-2030</p>
                                        </div>

                                        <div class="col-md-3">
                                            <label>Date Of Birth</label>
                                            <p class="text-light">12-08-1999</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>Blood Group</label>
                                            <p class="text-light">B+</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>Gender</label>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <p class="text-light">Gts829282</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>Voter Id</label>
                                            <p class="text-light">89202992002</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>License Number</label>
                                            <p class="text-light">290829927</p>
                                        </div>

                                        <div class="col-md-3">
                                            <label>Email Id</label>
                                            <p class="text-light">kumar@gmail.com</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>License Address</label>
                                            <p class="text-light">101 anna nagar street chennai</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>License Issue Date</label>
                                            <p class="text-light">2-08-2030</p>
                                        </div>
                                ...
                                <div class="tab-pane fade card p-4 mb-3" id="gallery" role="tabpanel" aria-labelledby="pills-contact-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3  my-2">
                                            ...
                                            <img src="../head/assets/img/interior (1).jpg" onclick="openModal();currentSlide(1)" class="room-details-shadow  cursor rounded" width="200px" height="120px">
                                        </div>
                                        <div class="col-md-3  my-2 ">
                                            <div class="my-2">
                                                <label>Pan Card</label>
                                            </div>
                                            <img src="../head/assets/img/interior (2).jpg" onclick="openModal();currentSlide(2)" class="room-details-shadow cursor  rounded" width="200px" height="120px">
                                        </div>
                                        <div class="col-md-3  my-2">
                                            <div class="my-2">
                                                <label>Voter Id</label>
                                            </div>
                                            <img src="../head/assets/img/interior (3).jpg" onclick="openModal();currentSlide(3)" class="room-details-shadow  cursor rounded" width="200px" height="120px">
                                        </div>
                                        <div class="col-md-3  my-2 ">
                                            <div class="my-2">
                                                <label>License Card</label>
                                            </div>
                                            <img src="../head/assets/img/interior (4).jpg" onclick="openModal();currentSlide(4)" class="room-details-shadow  cursor rounded" width="200px" height="120px">
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade card p-4 mb-3" id="license_renewal_history" role="tabpanel" aria-labelledby="pills-contact-tab">
                                    <div class="row">
                                        <div class="d-flex justify-content-between">
                                            <h4 class="text-primary">License Renewal History</h4>
                                        </div>

                                        <div class="col-md-3">
                                            <label>License Number</label>
                                            <p class="text-light">3253465343</p>
                                        </div>
                                        <div class="col-md-3">
                                            <label>License Renewal On</label>
                                            <p class="text-light">11-02-2002</p>
                                        </div>

                                        <div class="col-md-3">
                                            <label>License Expired On</label>
                                            <p class="text-light">12-08-2022</p>
                                        </div>

                                        <div class="col-md-3">
                                            <label>Updated On</label>
                                            <p class="text-light">12-03-2023</p>
                                        </div>
                                ...
                                <div class="tab-pane fade card  p-4 mb-3" id="license_renewal_history" role="tabpanel" aria-labelledby="pills-contact-tab">
                                    <div class="card-body">Feedback and Review</div>
                                </div>
                            </div>
