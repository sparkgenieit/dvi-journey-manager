...
require_once('driver_invoice.php');
...
<body>
  ...
  <script>
        $(document).ready(function() {
            <?php if ($_GET['route'] == '') : ?>
                show_DRIVER_INVOICE_LIST();
            <?php elseif (($_GET['route'] == 'preview' || $_GET['route'] == 'edit') && $_GET['formtype'] == 'driver_invoice_details') : ?>
                show_DRIVER_INVOICE_DETAIL('<?= $_GET['route']; ?>', '<?= $_GET['id']; ?>');
            <?php endif; ?>
        });

        function show_DRIVER_INVOICE_LIST() {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_driver_invoice_list.php?type=show_form',
        ...
        function show_DRIVER_INVOICE_DETAIL(TYPE, ID) {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_driver_invoice_details.php?type=show_form',
                data: {
                    ID: ID,
                    TYPE: TYPE
                },
