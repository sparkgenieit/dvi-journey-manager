...
<head>
    ...
    <style>
        ...
        table .all-components-head th {
            background-color: #7231cf0a !important;
            color: #545355d6 !important;
            font-weight: bold;
        }

        .table-hover>tbody>tr:hover> {
            --bs-table-accent-bg: rgba(75, 70, 92, 0) !important;
        }
...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <span id="showACCOUNTSMANAGERLIST"></span>
                    </div>
                    <!-- / Content -->
                    <!-- Footer -->
    ...
    <script>
        $(document).ready(function() {
            ...
            <?php if ($_GET['route'] == '') : ?>
                show_ACCOUNTSMANAGER_PREVIEW('<?= $_GET['id']; ?>');
            <?php endif; ?>
        });

        function show_ACCOUNTSMANAGER_PREVIEW(ID) {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_accountsmanager_main.php?type=show_form',
                success: function(response) {
                    $('#showACCOUNTSMANAGERLIST').html(response);
                }
            });
        }
    </script>
