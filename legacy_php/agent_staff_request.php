...
$current_page = 'agent_staff_request.php';
...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <span id="showAGENTSTAFF_REQUEST_LIST"></span>
                    </div>
                    <!-- / Content -->
                </div>
                <!-- Footer -->
    ...
    <script>
        ...
        function show_AGENT_LIST() {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_agent_staff_request_list.php',
                success: function(response) {
                    $('#showAGENTSTAFF_REQUEST_LIST').html(response);
                }
            });
        }
    </script>
