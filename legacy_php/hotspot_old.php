...
$current_page = 'hotspot.php'; // Set the current page variable
...
<head>
    ...
    <?php if ($_GET['formtype'] == 'activity_pricebook') : ?>
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <div class="col-md-12">
                                    <div class="card p-0">
                                        <div class="card-header pb-3 d-flex justify-content-between">
                                            <h5 class="card-title mb-3">List of Hotspot</h5>

                                            <a href="javascript:void(0)" class="btn btn-label-primary waves-effect" onclick="showaddHOTSPOTADDFORMMODAL(0);" data-bs-dismiss="modal">+ Add Hotspot</a>
                                        </div>

                                        <div class="card-body dataTable_select text-nowrap">
                                            <div class="text-nowrap">
                                                <table class="table table-flush-spacing table-hover" id="hotspot_LIST">
                                                    <thead class="table-head">
                                                        <tr>
                                                            <th scope="col">S.No</th>
                                                            <th scope="col">Hotspot Image</th>
                                                            <th scope="col">Hotspot Name</th>
                                                            <th scope="col">Hotspot Address</th>
                                                            <th scope="col">Hotspot Type</th>
                        ...
                        <?php elseif (isset($_GET['route']) && ($_GET['route'] == 'preview')) :

                            $hotspot_ID = $_GET['id'];

                            $select_hotspot_query = sqlQUERY_LABEL("SELECT `hotspot_ID`, `hotspot_place_id`, `hotspot_type`, `hotspot_name`, `hotspot_description`, `hotspot_address`, `hotspot_landmark`,  `hotspot_operating_hours`, `hotspot_entry_cost`, `hotspot_photo_url`, `hotspot_rating`, `hotspot_latitude`, `hotspot_longitude` FROM `dvi_hotspot_place` WHERE `deleted` = '0' and `hotspot_ID` = '$hotspot_ID'  ORDER BY `hotspot_ID` DESC") or die("#1-UNABLE_TO_COLLECT_HOTEL_LIST:" . sqlERROR_LABEL());
                            ...
                            while ($fetch_list_data = sqlFETCHARRAY_LABEL($select_hotspot_query)) :
                                ...
                                // $hotspot_km = $fetch_list_data['hotspot_km'];
                            ...
                            <div class="card p-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p class="text-light"><?= $hotspot_type ?></p>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Hotspot Name</label>
                                        <p class="text-light"><?= $hotspot_name ?></p>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Address </label>
                                        <p class="text-light"><?= $hotspot_address ?></p>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p class="text-light"><?= $hotspot_landmark ?></p>
                                    </div>
                                    <!-- <div class="col-md-3">
                                        <label>Hotspot km</label>
                                        <p class="text-light"><?= $hotspot_km ?></p>
                                    </div> -->
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p class="text-light"><?= $hotspot_entry_cost ?></p>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Rating</label>
                                        <p class="text-light"><?= $hotspot_rating ?></p>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Image</label>
                                        <!-- <p class="text-light"><?= $hotspot_name ?></p> -->
                                        <div>
                                            <img src='<?= BASEPATH . '/uploads/hotspot_gallery/' . $hotspot_photo_url ?>' alt="image not found" style="width:100px; height:100px; border-radius:5px;" />
                                        </div>
                                    </div>

                                    <iframe width="600" height="450" style="border:0;" loading="lazy" allowfullscreen="" referrerpolicy="no-referrer-when-downgrade" src="https://maps.google.com/maps?q=<?= $hotspot_latitude; ?>,<?= $hotspot_longitude; ?>&z=15&output=embed"></iframe>
            ...
            <div class="modal fade" id="addHOTSPOTADDFORM" tabindex="-1" aria-hidden="true">

                <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
                    <div class="modal-content">
                        <div class="receiving-hotspot-add-form-data">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('#hotspot_LIST').DataTable({
                        dom: '<"row align-items-center"<"col-md-6" l><"col-md-6" f>><"table-responsive my-3 scrollbar-hidden" rt><"row align-items-center" <"col-md-6" i><"col-md-6" p>><"clear">',
                        "bFilter": false,
                        buttons: [
                            'copyHtml5',
                            'excelHtml5',
                        ...
                        columns: [{
                            ...
                            {
                                data: "hotspot_photo_url"
                            }, //1
                            {
                                data: "hotspot_name"
                            }, //2
                            {
                                data: "hotspot_address"
                            }, //3
                            {
                                data: "hotspot_type"
                            }, //4
                        ...
                        columnDefs: [{
                                ...
                                "render": function(data, type, row, full) {
                                    if (data && data !== '') {
                                        return '<img src="' + data + '" alt="image" style="width:100px; height:100px; border-radius:5px;"/>';
                                    } else {
                                        return '<img src="assets/img/itinerary/hotspots/image-not-found.jpg" alt="Image not found" style="width:100px; height:100px; border-radius:5px;"/>';
                                    }
                                }
                            },
                            {
                ...
                function showaddHOTSPOTADDFORMMODAL(HOTSPOT_ID) {
                    $('.receiving-hotspot-add-form-data').load('engine/ajax/__ajax_add_hotspot_form.php?type=show_form&HOTSPOT_ID=' + HOTSPOT_ID + '', function() {
                        const container = document.getElementById("addHOTSPOTADDFORM");

                        const modal = new bootstrap.Modal(container);
                        modal.show();
                        if (HOTSPOT_ID) {
                            $('#HOTSPOTFORMLabel').html('Update Hotspot');
                        } else {
                            $('#HOTSPOTFORMLabel').html('Add Hotspot');
                        }
                    });
                }

                //ADD ACTIVITY
                function showHOTSPOTFORM(TYPE, ID) {
                    alert();
                    $.ajax({
                        type: 'post',
                        url: 'engine/ajax/__ajax_add_hotspot_form.php.php?type=edit_form',
                        data: {
                            ID: ID,
                            TYPE: TYPE
                        },
                        success: function(response) {
                            $('#showHOTSPOTFORM').html(response);
                        }
                    });
                }
            </script>
