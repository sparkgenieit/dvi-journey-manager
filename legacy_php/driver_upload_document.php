...
<style>
  /* Style for the uploaded file container */
  .uploaded-file {
    display: block;
    margin: 20px;
    padding: 10px;
  ...
  /* Style for the download icon (visible by default) */
  .download-icon {
    display: inline;
    cursor: pointer;
  }
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-12">
                <div class="card p-4">
                  <div class="justify-content-center bulk-upload-body">
                    <div class="card-body bulk-import-body text-center p-5" id="uploadedFileContainer">
                      ...
                      <a id="downloadLink" class="download-icon" download><img src="download-icon.png" alt="Download"></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row mt-3">
              <div class="col-12">
                <div class="card p-4" id="uploadButtonCard">
                  <div class="justify-content-center bulk-upload-body">
