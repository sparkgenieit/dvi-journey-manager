...
if ($total_itinerary_plan_details_count > 0) :
    ...
    while ($fetch_itinerary_plan_data = sqlFETCHARRAY_LABEL($select_voucher_plan_details)) :
        ...
        $pdf->writeHTML($table_company_details, true, false, false, false, '');
                                ...
                                <table cellspacing="0" cellpadding="8" border="0">
                                    <tr>
                                        <td width="100%" height="111px" style="border:4px solid #d3d3d3;">
                                            ...
                                            <span style="font-weight:regular; font-size:12px; color:#8e8a8a;">Booking ID : </span><span style="font-weight:bold; font-size:12px; color:#232323;">' . $itinerary_quote_ID . '</span>
                                                <br/>
                                                <br/>
                                            <span style="font-weight:bold; font-size:16px; color:#232323">' . $hotel_name . '</span><br/>
                                    ...
                                    <tr>
                                        <td width="25%" style="border:4px solid #d3d3d3;">
                                          <br/>
                                            <span style="font-weight:regular; font-size:12px; color:#8e8a8a;">Check-In Date:</span><br/>
                                            <span style="font-weight:semi-bold; font-size:12px; color:#232323;">' . dateformat_datepicker($itinerary_route_date) . ' ' . date('h:i A', strtotime($check_in_time)) . '</span>
                                        </td>
                                        <td width="26%"  style="border:4px solid #d3d3d3;">
                                            <br/>
                                            <span style="font-weight:regular; font-size:12px; color:#8e8a8a;">Check-Out Date:</span><br/>
                                            <span style="font-weight:semi-bold; font-size:12px; color:#232323;">' . dateformat_datepicker(date('Y-m-d', strtotime($itinerary_route_date . ' +1 day'))) . ' ' . date('h:i A', strtotime($check_out_time)) . '</span>
                                        </td>
                                        <td width="49%"  style="border:4px solid #d3d3d3;">
                                            <br/>
                                            <span style="font-weight:regular; font-size:12px; color:#8e8a8a;">Booking Details:</span><br/>
                                            <span style="font-weight:semi-bold; font-size:12px; color:#232323;">' . $preferred_room_count . ' Rooms | ' . $formattedoccupancyDetails . '</span><br/>
                                            <span style="font-weight:semi-bold; font-size:12px; color:#232323;">' . $room_type . '</span>
                                        </td>
                                    </tr>
                                        <tr>
                                            <td width="51%" align="left" style="font-size: 12px; border:4px solid #d3d3d3;"><span style="color:#8e8a8a;font-weight:regular;">Number of Guests</span><br/>' . $total_adult . ' Adults | Childrens - ' . $total_children . ' | Infants - ' . $total_infants . '.</td>

                                            <td width="49%" align="left" style="font-size: 12px; border:4px solid #d3d3d3;"><span style="color:#8e8a8a;font-weight:regular;">Meal plan</span><br/>' . $meal_plan . '' . $meal_breakfast . '' . $meal_lunch . '' . $meal_dinner . '<br/><span style="color:#8e8a8a;font-weight:regular;">Food Type</span><br/>' . $food_type_format . '</td>
                                        </tr>
                                        <tr>
                                            <td width="51%" align="left" style="font-size: 12px; border:4px solid #d3d3d3;"><span style="color:#8e8a8a;font-weight:regular;">Rate<br/></span>' . $formatRoomDetails . '</td>

                                            <td width="49%" align="left" style="font-size: 12px; border:4px solid #d3d3d3;"><span style="color:#8e8a8a;font-weight:regular;">Extra bed </span><span> 0</span> <br/><span style="color:#8e8a8a;font-weight:regular;">Child With bed</span><span> 1</span><br/><span style="color:#8e8a8a;font-weight:regular;">Child Without bed</span><span> 1</span> </td>
                                        </tr>
                                </table>
                            </td>
                            <td width="40%"><table cellspacing="0" cellpadding="17" border="0">
                                    <tr>
                                        <td width="100%" style="border:4px solid #d3d3d3; line-spacing:15px; ">
                                            <br/>
                                            <span style="font-size:12px;color:#8e8a8a;font-weight:regular;">Guest Details: </span><br/><br/>
                                            <span style="font-weight:bold;font-size:16px;color:#232323;">' . $customer_name . '</span>
                                                ...
                                                <br/><span style="font-weight:semi-bold;font-size:12px;color:#232323;">Bharathirajathangappalam@gmail.com</span>
                                                <br/><br/><span style="font-weight:bold;font-size:16px;' . $booking_status_color . '">'. $hotel_booking_status.'</span>
                                        </td>
                                    </tr>
                                    <tr>
                                            <td width="100%" align="left" style="font-size: 12px; border:4px solid #d3d3d3;"><span style="color:#8e8a8a;font-weight:regular;">Confirmed by Details:</span><br/><br/>' . $hotel_confirmed_by . '<br/>' . $hotel_confirmed_email_id . '<br/>' . $hotel_confirmed_mobile_no . '
                                            <br/><br/><span style="color:#8e8a8a;font-weight:regular;">Special Requests</span><br/>( here any special request )
                                            </td>
                                        </tr>
                                </table>
                            </td>
  ...
  // Reset $table_data for the next record
  $table_data = '';
