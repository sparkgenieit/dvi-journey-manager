...
<body>
                ...
                <div class="card p-3">
                  <div class="card-header p-3 d-flex justify-content-between">
                    ...
                    <div class="col-md-4 text-end">
                      <a href="driver.php?route=add&formtype=driver_basic_info" id="add_driver" class="btn btn-label-primary waves-effect me-2" onclick=showLICENSERENEWALDETAILS(0);>+ Add License Renewal</a>
                    </div>
                  </div>
                  <div class="card-datatable dataTable_select text-nowrap">
                    <table id="driver_LICENSERENEWAL_LIST" class="dt-select-table table-bordered table">
                      <thead>
                        <tr>
                          <th>S.no</th>
  ...
  <script>
    ...
    $(document).ready(function() {
      $('#driver_LICENSERENEWAL_LIST').DataTable({
        dom: 'Blfrtip',
        "bFilter": true,
        buttons: [
          'copyHtml5',
