...
<body>
                                ...
                                <div class="card p-0">
                                    <div class="card-header pb-3 d-flex justify-content-between">
                                        <div class="col-md-auto">
                                            <h5 class="card-title mb-3 mt-2">List of Daily Moment</h5>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#hotel_LIST tbody').on('click', 'tr', function() {
            ...
            <tr class="detail-row">
                    ...
                    <div class="card">
                        <div class="py-4">
                          <div class="d-flex justify-content-between px-4 mb-4">
                            <h5 class="card-title m-0">Daily Moment Details</h5>
                            <a class="close-detail-row text-danger cursor-pointer"><i class="ti ti-square-rounded-x me-1 mb-1"></i></i>Close</a>
                          </div>

                            <div class="d-flex align-items-center justify-content-between px-4 mb-3" style="background-color: #dff7e985; padding: 7px 0px;">
                            <div class="d-flex align-items-center"> 
                              <div class="blink me-3"><img src="assets/img/current-calender2.png" width="20px"/></div>
                                <div> <p class="m-0">DAY 4 - Mon, Sep 02, 2024</p>
                                <h5 class="m-0">Chennai Central Railway <span><i class="ti ti-arrow-big-right-lines"></i></span> Chennai Central Railway </h5></div>
                            </div>
                             <div><span class="badge bg-warning">In-progress</span></div>
                          </div>

                          <div class="d-flex align-items-center justify-content-between px-4 mb-3">
                            <div> <p class="m-0">DAY 1 - Mon, Sep 02, 2024</p>
                             <h5 class="m-0">Chennai Central Railway <span><i class="ti ti-arrow-big-right-lines"></i></span> Chennai Central Railway </h5>
                             </div>
                             <div><span class="badge bg-success">Visited</span></div>
                          </div>
                          <div class="d-flex align-items-center justify-content-between px-4 mb-3">
                            <div> <p class="m-0">DAY 2 - Mon, Sep 02, 2024</p>
                             <h5 class="m-0">Chennai Central Railway <span><i class="ti ti-arrow-big-right-lines"></i></span> Chennai Central Railway </h5>
                             </div>
                              <div><span class="badge bg-secondary">Not-Visited</span></div>
                          </div>
                          <div class="d-flex align-items-center justify-content-between px-4 mb-3">
                            <div> <p class="m-0">DAY 3 - Mon, Sep 02, 2024</p>
                             <h5 class="m-0">Chennai Central Railway <span><i class="ti ti-arrow-big-right-lines"></i></span> Chennai Central Railway </h5>
                             </div>
                             <div><span class="badge bg-success">Visited</span></div>
                          </div>
                          ...
                          <div class="d-flex align-items-center justify-content-between px-4 mb-3">
                            <div> <p class="m-0">DAY 5 - Mon, Sep 02, 2024</p>
                             <h5 class="m-0">Chennai Central Railway <span><i class="ti ti-arrow-big-right-lines"></i></span> Chennai Central Railway </h5>
                             </div>
                             <div><span class="badge bg-secondary">Not-Visited</span></div>
                          </div>
                ...
                // Insert the card HTML after the clicked row
                $(this).after(cardHtml);
            });

            // Use event delegation to handle the close button click
            $('#hotel_LIST').on('click', '.close-detail-row', function(event) {
