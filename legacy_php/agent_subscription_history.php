...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <span id="show_subscription_historyLIST"></span>
    ...
    <script>
        ...
        function show_staff_LIST() {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_subscription_history_list.php?type=show_form',
                success: function(response) {
                    $('#show_subscription_historyLIST').html(response);
                }
            });
        }
    </script>
