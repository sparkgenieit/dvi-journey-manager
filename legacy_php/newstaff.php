...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <span id="showstaffLIST"></span>
                        <span id="showstaffFORMSTEP1"></span>
                        <!-- <span id="showagentSTAFF"></span> -->
                        <span id="showstaffPREVIEW"></span>
    ...
    <script>
        ...
        function show_staff_LIST() {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_staff_list.php?type=show_form',
                success: function(response) {
                    $('#showstaffLIST').html(response);
        ...
        function showstaffFORMSTEP1(ID, ROUTE, TYPE) {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_add_staff_newform.php?type=basic_info&ROUTE=' + ROUTE + '&ID=' + ID,
                success: function(response) {
                    $('#showstaffLIST').html('');
                    $('#showstaffFORMSTEP1').html(response);
                    $('#showstaffPREVIEW').html('');
                }
            });
        }

        function show_STAFF_PREVIEW(TYPE, ID) {
            $.ajax({
                type: 'post',
                url: 'engine/ajax/__ajax_staff_overall_preview.php?type=staff_preview',
                data: {
                    ID: ID,
                    TYPE: TYPE
                },
                success: function(response) {
                    $('#showstaffLIST').html('');
                    $('#showstaffFORMSTEP1').html('');
                    $('#showstaffPREVIEW').html(response);
                }
            });
        }
        ...
        function togglevehiclestatusITEM(STATUS_ID, VEHICLE_ID) {
            if (VEHICLE_ID) {
                $.ajax({
                    type: "POST",
                    url: "engine/ajax/__ajax_manage_staff.php?type=vehicleupdatestatus",
                    data: {
