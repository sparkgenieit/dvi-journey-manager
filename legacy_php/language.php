...
$current_page = 'language.php'; // Set the current page variable
...
<body>
                            ...
                            <div class="col-md-12">
                                <div class="card p-0">
                                    <div class="card-header pb-3 d-flex justify-content-between">
                                        <h5 class="card-title mb-3">List of Language</h5>
                                        <a href="javascript:void(0)" class="btn btn-label-primary waves-effect" onclick="showLANGUAGEMODAL(0);" data-bs-dismiss="modal">+ Add Language</a>
                                    </div>
    ...
    <div class="modal fade" id="addLANGUAGEFORM" tabindex="-1" aria-hidden="true">
    ...
    <script>
        $(document).ready(function() {
            $('#language_LIST').DataTable({
                ...
                ajax: {
                    "url": "engine/json/__JSONlanguage.php",
                    "type": "GET"
                },
                columns: [{
                        data: "count"
        ...
        function showLANGUAGEMODAL(LANGUAGE_ID) {

            $('.receiving-language-form-data').load('engine/ajax/__ajax_add_language_form.php?type=show_form&LANGUAGE_ID=' + LANGUAGE_ID + '', function() {
                const container = document.getElementById("addLANGUAGEFORM");
                const modal = new bootstrap.Modal(container);
                modal.show();
                if (LANGUAGE_ID) {
                    $('#LANGUAGEFORMlabel').html('Update Language');
                } else {
        ...
        //SHOW DELETE POPUP
        function showDELETELANGUAGEMODAL(ID) {
            $('.receiving-confirm-delete-form-data').load('engine/ajax/__ajax_manage_language.php?type=delete&ID=' + ID, function() {
        ...
        function confirmLANGUAGEDELETE(ID) {
            $.ajax({
                type: "POST",
                url: "engine/ajax/__ajax_manage_language.php?type=confirmdelete",
                data: {
                    _ID: ID
                },
                dataType: 'json',
        ...
        function togglestatusITEM(STATUS_ID, LANGUAGE_ID) {
            if (LANGUAGE_ID) {
                $.ajax({
                    type: "POST",
                    url: "engine/ajax/__ajax_manage_language.php?type=updatestatus",
                    data: {
