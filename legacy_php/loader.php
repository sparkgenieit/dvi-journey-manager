...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <button id="showLoaderBtn">Show Loader</button>
    ...
    <?php if (!($_GET['route'] == 'preview' && $_GET['formtype'] == 'preview' && $_GET['request'] == '')) : ?>
        <script src="assets/js/app-hotel-calendar.js?id=<?= $_GET['id']; ?>&roomTypeFilterValue=" + roomTypeFilterValue></script>
    <?php endif; ?>
