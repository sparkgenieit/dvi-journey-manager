...
<body>
                            ...
                            <div class="col-md-12">
                                <div class="card p-0">
                                    <div class="card-header pb-3 d-flex justify-content-between">
                                        <h5 class="card-title mb-3">List of Inbuilt Amenities</h5>
                                        <a href="javascript:void(0)" class="btn btn-label-primary waves-effect" onclick="showINBUILDAMENITYTYPEMODAL(0);" data-bs-dismiss="modal">+ Add Inbuild Amenity</a>
                                    </div>
                                    <div class="card-body dataTable_select text-nowrap">
                                        <div class="text-nowrap table-responsive table-bordered">
                                            <table class="table table-hover " id="inbuild_amenity_type_LIST">
                                                <thead class="table-head">
                                                    <tr>
                                                        <th scope="col">S.No</th>
                                                        <th scope="col">Action</th>
                                                        <th scope="col">Inbuild Amenity Title</th>
    ...
    <div class="modal fade" id="addAMENITYTYPEFORM" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
            <div class="modal-content p-3 p-md-5">
                <div class="receiving-inbuild-amenity-type-form-data">
    ...
    <script>
        $(document).ready(function() {
            $('#inbuild_amenity_type_LIST').DataTable({
                dom: 'Blfrtip',
                "bFilter": true,
                buttons: [{
                        extend: 'copy',
                ...
                ajax: {
                    "url": "engine/json/__JSONinbuildamenity.php",
                    "type": "GET"
                },
                columns: [{
                        data: "count"
        ...
        function showINBUILDAMENITYTYPEMODAL(AMENITY_TYPE_ID) {

            $('.receiving-inbuild-amenity-type-form-data').load('engine/ajax/__ajax_add_inbuild_amenity_type_form.php?type=show_form&AMENITY_TYPE_ID=' + AMENITY_TYPE_ID + '', function() {
                const container = document.getElementById("addAMENITYTYPEFORM");
                const modal = new bootstrap.Modal(container);
                modal.show();
                if (AMENITY_TYPE_ID) {
                    ''
                    $('#AMENITYTYPEFORMLabel').html('Update Inbuild Amenity');
                } else {
                    $('#AMENITYTYPEFORMLabel').html('Add Inbuild Amenity');
                }
            });
        }
        //SHOW DELETE POPUP
        function showDELETEVEHICLETYPEMODAL(ID) {
            $('.receiving-confirm-delete-form-data').load('engine/ajax/__ajax_manage_inbuild_amenity_type.php?type=delete&ID=' + ID, function() {
        ...
        function confirmINBUILDAMENITYTYPEDELETE(ID) {
            $.ajax({
                type: "POST",
                url: "engine/ajax/__ajax_manage_inbuild_amenity_type.php?type=confirmdelete",
                data: {
                    _ID: ID
                },
                dataType: 'json',
        ...
        function togglestatusITEM(STATUS_ID, AMENITY_TYPE_ID) {
            if (AMENITY_TYPE_ID) {
                $.ajax({
                    type: "POST",
                    url: "engine/ajax/__ajax_manage_inbuild_amenity_type.php?type=updatestatus",
                    data: {
