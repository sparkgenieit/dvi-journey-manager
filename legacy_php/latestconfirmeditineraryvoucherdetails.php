...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <span id="HOTEL_VOUCHER_DETAILS"></span>
    ...
    <script>
        ...
        function showOVERALL_COST_DETAILS(itinerary_plan_ID) {
            $.ajax({
                type: "POST",
                url: "engine/ajax/ajax_confirmed_itinerary_hotel_voucher_details.php?type=show_form",
                data: {
                    _itinerary_plan_ID: itinerary_plan_ID,
                },
                success: function(response) {
                    $('#HOTEL_VOUCHER_DETAILS').html('');
                    $('#HOTEL_VOUCHER_DETAILS').html(response);
                }
            });
        }
    </script>
