...
<span style="font-size: 14px; vertical-align: middle;color:#fff;">Over All Package Cost: <span style="font-family:DejaVuSans;">' . general_currency_symbol . '</span> ' . number_format(round(getITINEARY_COST_DETAILS($itinerary_plan_ID, $get_group_ID, 'itineary_gross_total_amount_pdf')), 2) . '</span>
...
$total_guide_charge = number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, '', 'total_guide_amount'), 2);
$total_hotel_charge = number_format(getITINEARY_COST_DETAILS($itinerary_plan_ID, $get_group_ID, 'total_hotel_amount'), 2);
